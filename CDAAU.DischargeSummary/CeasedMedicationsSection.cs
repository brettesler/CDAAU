...
namespace TeamUnicorn.CDAAU.DischargeSummary
{
    ...
    [RIMActCode(Code = "101.16146.4.1.2", CodeSystem = "1.2.36.1.2001.1001.101", CodeSystemName = "NCTIS Data Components", DisplayName = "Ceased Medications")]
    [RIMActTitle(Title = "Ceased Medications")]
    public class CeasedMedicationsSection
    {
        public CeasedMedicationsSection() { }
