      ...
      public static string ResultFileNameAndPath
      {
        ...
        public static void HydrateSubjectofCare(IParticipationSubjectOfCare subjectOfCare, bool mandatoryOnly)
        {
            ...
            if (!mandatoryOnly)
            {
                ...
                participant.Entitlements = new List<Entitlement> { entitlement1 };
        ...
        public static void HydrateAuthorV2(IParticipationDocumentAuthor author, bool mandatoryOnly)
        {
            ...
            if (!mandatoryOnly)
            {
                ...
                // Subject of Care > Participant > Entitlement
                var entitlement1 = BaseCDAModel.CreateEntitlement();
                entitlement1.Id = BaseCDAModel.CreateMedicareNumber(MedicareNumberType.MedicareCardNumber, "2296818481");
                entitlement1.Type = EntitlementType.MedicareBenefits;
                entitlement1.ValidityDuration = BaseCDAModel.CreateInterval(new ISO8601DateTime(DateTime.Now), new ISO8601DateTime(DateTime.Now));
...
//             null));
        ...
        public static OtherTestResult CreateOtherTestResultAttachment()
        {
            ...
            otherTestResult.ReportContent.ExternalData = BaseCDAModel.CreateExternalData(MediaType.PDF, ResultFileNameAndPath, "Path File"); ;
        ...
        public static IImagingExaminationResult CreateImagingResults(string name)
        {
          ...
          imagingResultGroup2.AnatomicalSite = CreateAnatomicalSite(
            ...
            imagingExaminationResult.ExaminationResultName = BaseCDAModel.CreateCodableText("1234", CodingSystem.METEOR, name, name, null);

            // Findings
            imagingExaminationResult.Findings = "Normal obstetric ultrasound with foetal biometry indicating getational age of 18W0D.";

            // Modality
            imagingExaminationResult.Modality = BaseCDAModel.CreateCodableText("371573008", CodingSystem.SNOMED, "Ultrasonography");
