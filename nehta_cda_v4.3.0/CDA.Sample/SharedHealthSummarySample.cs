...
namespace Nehta.VendorLibrary.CDA.Sample
{
    ...
    public class SharedHealthSummarySample
    {
        ...
        {
            var medicalHistory = SharedHealthSummary.CreateMedicalHistory();
            ...
            if (!mandatorySectionsOnly)
            {
                ...
                // Procedures
                var procedure1 = SharedHealthSummary.CreateProcedure();
                ...
                var medicalHistoryItem = SharedHealthSummary.CreateMedicalHistoryItem();
                ...
                var medicalHistoryItem1 = SharedHealthSummary.CreateMedicalHistoryItem();
                ...
                var medicalHistoryItem2 = SharedHealthSummary.CreateMedicalHistoryItem();
                ...
                var medicalHistoryItem3 = SharedHealthSummary.CreateMedicalHistoryItem();
                ...
                // Problem Diagnosis
                var diagnosis = SharedHealthSummary.CreateProblemDiagnosis();
            ...
            else
            {
                ...
                medicalHistory.ProblemDiagnosisExclusionStatement = SharedHealthSummary.CreateExclusionStatement();
                medicalHistory.ProblemDiagnosisExclusionStatement.Value = NCTISGlobalStatementValues.NoneKnown;

                medicalHistory.ProceduresExclusionStatement = SharedHealthSummary.CreateExclusionStatement();
