...
namespace CDA.R5Samples
{
    ...
    public class AdvanceCareInformationSample
    {
        ...
        public static DocumentProvenance CreateDocumentProvenance(Boolean mandatorySectionsOnly)
        {
        ...
        public static IParticipationAuthorPerson CreateDocumentAuthor(bool mandatoryOnly)
        {
            ...
            // Note: This field is required by the PCEHR Conformance Profile for Advance Care Planning.
            //       This field is optional in the Advance Care Planning Implementation Guide.
