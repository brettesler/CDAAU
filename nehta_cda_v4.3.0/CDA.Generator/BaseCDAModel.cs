...
namespace Nehta.VendorLibrary.CDA.Common
{
    ...
    public class BaseCDAModel
    {
      ...
      {
          return CreateCodableText(code, codeSystem, codeSystem.HasValue ? codeSystem.Value.GetAttributeValue<NameAttribute, string>(a => a.Version) : null, displayName, null, null);
      }
        ...
        /// <returns>CodableText</returns>
        public static ICodableText CreateCodableText(String code, CodingSystem? codeSystem, String displayName, String originalText)
      {
          return CreateCodableText(code, codeSystem, codeSystem.HasValue ? codeSystem.Value.GetAttributeValue<NameAttribute, string>(a => a.Version) : null, displayName, originalText, null);
      }
      ...
      {
          return CreateCodableText(code, codeSystem, codeSystem.HasValue ? codeSystem.Value.GetAttributeValue<NameAttribute, string>(a => a.Version) : null, displayName, originalText, translations);
      }
      ...
      /// <param name="translations">Any translations that are associated with this coadable text</param>
      /// <returns>CodableText</returns>
      public static ICodableText CreateCodableText(String code, CodingSystem? codeSystem, String codeSystemVersion, String displayName, String originalText, List<ICodableTranslation> translations)
      {
          var codableText = new CodableText();
