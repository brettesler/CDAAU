...
namespace Nehta.VendorLibrary.CDA.Generator
{
    ...
    public static partial class CDAGeneratorHelper
    {
            ...
            var clinicalDocument = new POCD_MT000040ClinicalDocument
                                       {
                                           ...
                                           code = CreateCodedWithExtensionElement(
                                                   ...
                                                   (CodingSystem)Enum.Parse(typeof(CodingSystem), cdaDocumentType.GetAttributeValue<NameAttribute, string>(x => x.CodeSystem)), 
                                                    cdaDocumentType.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null, null),
                                           effectiveTime = documentCreationTimeDateTime != null ? CreateTimeStampElementIso(documentCreationTimeDateTime) : CreateTimeStampElementIso(new ISO8601DateTime(DateTime.Now)),
                                           confidentialityCode = CreateCodedWithExtensionElement(null, null, null, null, null, null, null, NullFlavour.NotApplicable),
                                           ...
                                           completionCode = documentStatus != null ? CreateCodedWithExtensionElement(
                                                       ...
                                                       documentStatus.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null, null): null,
                ...
                if (document.DocumentType.HasValue)
                  relatedDocument.parentDocument.code = CreateCodedWithExtensionElement(
                          ...
                          (CodingSystem)Enum.Parse(typeof(CodingSystem), document.DocumentType.Value.GetAttributeValue<NameAttribute, string>(x => x.CodeSystem)),
                           document.DocumentType.Value.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null, null);
        ...
        internal static POCD_MT000040InFulfillmentOf CreateinFulfillmentOf(OrderDetails orderDetails)
        {
            ...
            inFulfillmentOf = new POCD_MT000040InFulfillmentOf
            {
                ...
                order = new POCD_MT000040Order
                {
                    ...
                    code = orderDetails.RequestedTestName != null ? CreateCodedWithExtensionElement(orderDetails.RequestedTestName) : null
                }
            };
        ...
        internal static POCD_MT000040Component3 CreateAdministrativeObservations(IParticipationSubjectOfCare subjectOfCareParticipation, Dictionary<string, List<Entitlement>> entitlements, StrucDocText customNarrative, String patientId, Boolean? showTemplateId, INarrativeGenerator narrativeGenerator)
        {
            var administrativeObservations =  CreateAdministrativeObservations(null, subjectOfCareParticipation, customNarrative, patientId, narrativeGenerator);
            ...
            foreach (KeyValuePair<string, List<Entitlement>> kvp in entitlements)
            {
                ...
                coverage2.AddRange(CreateEntitlements(kvp.Value, kvp.Key, RoleClass.ASSIGNED, ParticipationType.HLD).ToArray()); 
            }
        ...
        /// <param name="narrativeGenerator">The narrative generator with which to generate the narrative for this section / component</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateAdministrativeObservations(IParticipationDocumentAuthor authorPersonParticipation, IParticipationSubjectOfCare subjectOfCareParticipation, StrucDocText customNarrative, String patientId, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (subjectOfCareParticipation != null && subjectOfCareParticipation.Participant != null && subjectOfCareParticipation.Participant.Person != null)
          {
                ...
                subjectOfCareParticipation.Participant.Entitlements != null)
            {
              ...
              // Entitlements
              if (patientId != null && subjectOfCareParticipation.Participant.Entitlements != null && subjectOfCareParticipation.Participant.Entitlements.Any())
                 coverages.AddRange(CreateEntitlements(subjectOfCareParticipation.Participant.Entitlements, patientId, RoleClass.PAT, ParticipationType.BEN));

              // Entitlements
              if (authorPersonParticipation != null && authorPersonParticipation.Participant != null && authorPersonParticipation.Participant.Entitlements != null && authorPersonParticipation.Participant.Entitlements.Any())
                 coverages.AddRange(CreateEntitlements(authorPersonParticipation.Participant.Entitlements, authorPersonParticipation.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD));
        ...
        /// <returns>an XmlElement containing a CDA reference to the external data</returns>
        internal static List<POCD_MT000040Component3> CreateNarrativeOnlyDocument(List<NarrativeOnlyDocument> narrativeOnlyDocuments)
        {
            ...
            if (narrativeOnlyDocuments != null && narrativeOnlyDocuments.Any())
            {
                components = narrativeOnlyDocuments.Select(narrativeOnlyDocument => new POCD_MT000040Component3
                {
                    ...
                    {
                        title = CreateStructuredText(narrativeOnlyDocument.Title), text = narrativeOnlyDocument.Narrative
                    }
                                                                               ...
                                                                               INarrativeGenerator narrativeGenerator)
        {
          ...
          if (reason != null && !String.IsNullOrEmpty(reason))
          {
            ...
            if (duration != null)
            {
              ...
              entryList.Add(CreateEntryObservationWithDuration(x_ActRelationshipEntry.COMP, CreateConceptDescriptor("103.16622", CodingSystem.NCTIS, "Referral Validity Duration", null), null, anyList, null, null));
            }

            if (dateTime != null)
            {
              entryList.Add(CreateEntryObservation(x_ActRelationshipEntry.COMP, CreateConceptDescriptor("103.16620", CodingSystem.NCTIS, "Referral DateTime", null), null, null, new List<ANY> { CreateTimeStampElementIso(dateTime) }, null, null));
            }
            ...
            //Add an entry containing the referral reason and the referenced referral reason document if one was supplied.
              entryList.Add(CreateEntryObservation(x_ActRelationshipEntry.COMP, CreateConceptDescriptor("42349-1", CodingSystem.LOINC, "Reason for referral", null), null, reasonForReferral, null, null));
        ...
        internal static POCD_MT000040Component3 CreateComponent(IList<IParticipationAcdCustodian> custodianParticipations, StrucDocText customNarrative, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (custodianParticipations != null && custodianParticipations.Any())
          {
            ...
            {
              code = CreateCodedWithExtensionElement("101.16694", CodingSystem.NCTIS, "ACD Custodian Entries", null, null, null),
        ...
        /// </summary>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(IList<IDiagnosticImagingExaminationResult> imagingExaminationResults,
                                                                ...
                                                                INarrativeGenerator narrativeGenerator)
        {
            ...
            if (imagingExaminationResults.Any() || relatedDocument != null)
            {
                ...
                if (reportingRadiologist != null)
                {
                    ...
                    // Entitlements
                    if (reportingRadiologist.Participant != null && reportingRadiologist.Participant.Entitlements != null && reportingRadiologist.Participant.Entitlements.Any())
                    {
                        diagnosticImagingReport.section.coverage2 = CreateEntitlements(reportingRadiologist.Participant.Entitlements, reportingRadiologist.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD).ToArray();
                    }
                }
                ...
                // The default narrative is set in CreateSectionCodeTitle at the top of this section
                diagnosticImagingReport.section.text = diagnosticImagingCustomNarrative ?? narrativeGenerator.CreateNarrative(reportingRadiologist, relatedDocument); 
            }
                ...
                entryRelatedDocument.act.reference = new[]
                {
                    new POCD_MT000040Reference
                    {
                        ...
                        externalDocument = new POCD_MT000040ExternalDocument
                        {
                            ...
                            id = documentDetails.DocumentProvenance != null ? CreateIdentifierArray(documentDetails.DocumentProvenance.DocumentIdentifier) : null,
                            code = documentDetails.DocumentProvenance != null && documentDetails.DocumentProvenance.DocumentType.HasValue ? CreateConceptDescriptor(CreateCodableText(documentDetails.DocumentProvenance.DocumentType.Value)) : null,
        ...
        /// </summary>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(IList<SCSModel.Common.PathologyTestResult> pathologyTestResults,
                                                                ...
                                                                INarrativeGenerator narrativeGenerator)
        {
            ...
            if (pathologyTestResults.Any())
            {
                ...
                if (reportingPathologist != null)
                {
                    ...
                    // Entitlements
                    if (reportingPathologist.Participant != null && reportingPathologist.Participant.Entitlements != null && reportingPathologist.Participant.Entitlements.Any())
                    {
                        pathologyComponent.section.coverage2 = CreateEntitlements(reportingPathologist.Participant.Entitlements, reportingPathologist.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD).ToArray();
                    }
                }
                ...
                if (relatedDocument != null)
                {
                    entriesList.Add(CreateEntryActRelatedDocument(relatedDocument, CreateCodableText(PatholodyResultReportSections.PathologyStudy)));
                }
                ...
                // The default narrative is set in CreateSectionCodeTitle at the top of this section
                pathologyComponent.section.text = pathologyCustomNarrative ?? narrativeGenerator.CreateNarrative(reportingPathologist, relatedDocument);
        ...
        /// </summary>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(IList<SCSModel.Pathology.PathologyTestResult> pathologyTestResults,
                                                                IParticipationReportingPathologist reportingPathologist,    
                                                                RelatedDocument relatedDocument,      
                                                                StrucDocText pathologyCustomNarrative, 
                                                                INarrativeGenerator narrativeGenerator)  {
        ...
        internal static List<POCD_MT000040Component3> CreateComponent(PhysicalMeasurement physicalMeasurement, StrucDocText customNarrative, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (physicalMeasurement != null)
          {
            ...
            component = new POCD_MT000040Component3
            {
              section = CreateSectionCodeTitle(PhysicalMeasurementDocumentSections.PhysicalMeasurements.GetAttributeValue<NameAttribute, string>(x => x.Code),
                                               (CodingSystem)Enum.Parse(typeof(CodingSystem), PhysicalMeasurementDocumentSections.PhysicalMeasurements.GetAttributeValue<NameAttribute, string>(x => x.CodeSystem)),
                                               PhysicalMeasurementDocumentSections.PhysicalMeasurements.GetAttributeValue<NameAttribute, string>(x => x.Name),
                                               null)
            };

            component.section.templateId = CreateIdentifierArray(PhysicalMeasurementDocumentSections.PhysicalMeasurements.GetAttributeValue<NameAttribute, string>(x => x.Identifier), null);
            ...
            if (physicalMeasurement.PhysicalMeasurementBodyHeightLength != null)
              entriesList.Add(CreateEntryBodyHeightLength(physicalMeasurement.PhysicalMeasurementBodyHeightLength));
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateMedicareViewExclusionStatement(ExclusionStatement exclusionStatement, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          if (exclusionStatement != null && !exclusionStatement.GeneralStatement.IsNullOrEmptyWhitespace())
          {
            ...
            entryList.Add(CreateExclusionStatement(exclusionStatement.GeneralStatement, "103.16135.172.1.3", "General Statement"));
            component.section.entry = entryList.ToArray();

            // Narrative
            component.section.text = exclusionStatement.CustomNarrative ?? narrativeGenerator.CreateNarrative(exclusionStatement);
          }
        ...
        internal static POCD_MT000040Component3 CreateComponent(MedicareDVAFundedServicesHistory medicareDvaFundedServicesHistory, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (medicareDvaFundedServicesHistory != null)
          {
            ...
            {
              entryList.Add(CreateExclusionStatement(medicareDvaFundedServicesHistory.ExclusionStatement.GeneralStatement, "103.16135.172.1.5", "General Statement"));

              var section = CreateSectionCodeTitle
                            (
                                       MedicareOverviewSections.MedicareDVAFundedServicesExclusionStatement.GetAttributeValue<NameAttribute, string>(x => x.Code),
                                       CodingSystem.NCTIS,
        ...
        internal static POCD_MT000040Component3 CreateComponent(PharmaceuticalBenefitsHistory pharmaceuticalBenefitsHistory, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (pharmaceuticalBenefitsHistory != null)
          {
            ...
            {
              entryList.Add(CreateExclusionStatement(pharmaceuticalBenefitsHistory.ExclusionStatement.GeneralStatement, "103.16135.172.1.4", "General Statement"));

              var section = CreateSectionCodeTitle
                            (
                                 MedicareOverviewSections.PharmaceuticalBenefitItemsExclusionStatement.GetAttributeValue<NameAttribute, string>(x => x.Code),
                                 CodingSystem.NCTIS,
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(MedicalHistory medicalHistory, bool showExclusionStatements, INarrativeGenerator narrativeGenerator)
        {
            POCD_MT000040Component3 component = null;
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(List<IDocumentWithHealthEventEnded> documents, StrucDocText customNarrative, DocumentSections documentSections, DocumentProvenanceEnum documentProvenanceEnum, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          {
            entryList.AddRange(documents.Select(document => CreateDocument(document as Document, documentProvenanceEnum)));
            component.section.entry = entryList.ToArray();
          }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(List<IDocument> documents, StrucDocText customNarrative, DocumentSections documentSections, DocumentProvenanceEnum documentProvenanceEnum, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(Immunisations immunisations, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          if (immunisations != null)
          {
            ...
            component.section.entry = entryList.ToArray();
            component.section.text = immunisations.CustomNarrativeImmunisation ?? narrativeGenerator.CreateNarrative(immunisations);
        ...
        /// <param name="narrativeGenerator">The narrative generator with which to generate the narrative for this section / component</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateAdministrativeObservations(IParticipationSubjectOfCare subjectOfCareParticipation, StrucDocText customNarrative, String patientId, bool showEntitlements, INarrativeGenerator narrativeGenerator)
        {
          // Remove the Entitlements section from Subject Of Care
          if (!showEntitlements && subjectOfCareParticipation.Participant != null) subjectOfCareParticipation.Participant.Entitlements = null;

          return CreateAdministrativeObservations(null, subjectOfCareParticipation, customNarrative, patientId, narrativeGenerator);
        }
        ...
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateAdministrativeObservationsFiltering(IParticipationSubjectOfCare subjectOfCareParticipation, StrucDocText customNarrative, String patientId, ISO8601DateTime earliestDateForFiltering, ISO8601DateTime latestDateForFiltering, INarrativeGenerator narrativeGenerator)
        {
          var component = CreateAdministrativeObservations(null, subjectOfCareParticipation, customNarrative, patientId, narrativeGenerator);
          ...
          {
            component.section.text = new StrucDocText();
            component.section.text = customNarrative ?? narrativeGenerator.CreateNarrative(subjectOfCareParticipation, patientId, true, earliestDateForFiltering, latestDateForFiltering);
          }
          else
          {
            component.section.text = null;
        ...
        /// <param name="narrativeGenerator">The narrative generator with which to generate the narrative for this section / component</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateAdministrativeObservations(IParticipationSubjectOfCare subjectOfCareParticipation, IParticipationAuthorHealthcareProvider author, StrucDocText customNarrative, String patientId, string templateId, INarrativeGenerator narrativeGenerator)
        {
          var component = CreateAdministrativeObservations(null, subjectOfCareParticipation, customNarrative, patientId, narrativeGenerator);
          ...
          // Entitlements
          if (author != null && author.Participant != null && (author.Participant.Person != null && (author.Participant.Person.Entitlements != null && author.Participant.Person.Entitlements.Any())))
          {
            var listCoverage = new List<Coverage2>(component.section.coverage2);

            listCoverage.AddRange(CreateEntitlements(author.Participant.Person.Entitlements, author.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD).ToArray());
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static List<POCD_MT000040Component5> CreateComponent(List<IImagingExaminationResult> imagingExaminationResults, CDADocumentType? cdaDocumentType, INarrativeGenerator narrativeGenerator)
        {
            var componentList = new List<POCD_MT000040Component5>();
            ...
            if (imagingExaminationResults != null && imagingExaminationResults.Any())
            {
                foreach (var imagingExaminationResult in imagingExaminationResults)
                {
                    ...
                    {
                        relationshipList.Add(CreateRelationshipForTestResultStatus(imagingExaminationResult.ExaminationResultStatus));
                    }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static List<POCD_MT000040Component5> CreateComponent(List<SCSModel.Common.PathologyTestResult> pathologyTestResults, CDADocumentType? cdaDocumentType, INarrativeGenerator narrativeGenerator)
        {
            var componentList = new List<POCD_MT000040Component5>();
            ...
            if (pathologyTestResults != null)
            {
                foreach (var pathologyTestResult in pathologyTestResults)
                {
                    ...
                    {
                        relationshipList.AddRange(CreateRelationshipForEachSpecimenDetail(pathologyTestResult.TestSpecimenDetail, cdaDocumentType));
                    }

                    //Create relationships covering the test result groups
                    if (pathologyTestResult.ResultGroup != null)
                    {
                        relationshipList.AddRange(CreateRelationshipForEachTestResultGroup(pathologyTestResult.ResultGroup, cdaDocumentType));
                    }
                    ...
                    if (pathologyTestResult.DiagnosticService != null)
                    {
                        relationshipList.Add(
                            CreateEntryRelationshipObservation(x_ActRelationshipEntryRelationship.COMP,
                                                               CreateConceptDescriptor("310074003", CodingSystem.SNOMED, "pathology service", null, null, null),
                    ...
                    {
                        relationshipList.Add(CreateRelationshipForTestResultStatus(pathologyTestResult.OverallTestResultStatus));
                    }
                    ...
                    {
                        relationshipList.AddRange(pathologyTestResult.TestRequestDetails.Select(CreateRelationshipForTestRequestDetails));
                    }
                    ...
                    var observation = CreateEntryObservation(x_ActRelationshipEntry.COMP,
                                                             ...
                                                             null,
                                                             relationshipList,
                                                             reportingPathologist != null ? new List<POCD_MT000040Participant2> { reportingPathologist } : null);

                    if (pathologyTestResult.ReportingPathologist != null)
                    {
                        // Entitlements
                        if (pathologyTestResult.ReportingPathologist.Participant != null && pathologyTestResult.ReportingPathologist.Participant.Entitlements != null && pathologyTestResult.ReportingPathologist.Participant.Entitlements.Any())
                        {
                            pathologyTestResultComponent.section.coverage2 = CreateEntitlements(pathologyTestResult.ReportingPathologist.Participant.Entitlements, pathologyTestResult.ReportingPathologist.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD).ToArray();
                        }
                    }
        ...
        internal static POCD_MT000040Component3 CreateComponent(IDiagnosticInvestigations diagnosticInvestigations, CDADocumentType? cdaDocumentType, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (diagnosticInvestigations != null)
          {
            ...
            if (diagnosticInvestigations.PathologyTestResult != null && diagnosticInvestigations.PathologyTestResult.Any())
            {
                componentList.AddRange(CreateComponent(diagnosticInvestigations.PathologyTestResult, cdaDocumentType, narrativeGenerator));
            }
            ...
            {
                componentList.AddRange(CreateComponent(diagnosticInvestigations.ImagingExaminationResult, cdaDocumentType, narrativeGenerator));
            }
        ...
        internal static POCD_MT000040Component3 CreateComponent(IResponseDetails responseDetails, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (responseDetails != null)
          {
            ...
            if (responseDetails.Diagnoses != null && responseDetails.Diagnoses.Any())
            {
              ...
              {
                entryList.Add(CreateEntryObservation(CreateConceptDescriptor("282291009", CodingSystem.SNOMED, "Diagnosis interpretation", null), CreateConceptDescriptor(diagnosis)));
              }
            }
            ...
            if (responseDetails.OtherDiagnosisEntries != null && responseDetails.OtherDiagnosisEntries.Any())
            {
              if (responseDetails.OtherDiagnosisEntries != null)
                ...
                {
                  entryList.Add(CreateEntryActEvent(CreateConceptDescriptor("102.15513.132.1.1", CodingSystem.NCTIS, "Other Diagnosis Procedure Entry", null), CreateStructuredText(otherDiagnosis, null)));
                }
            }
            ...
            {
              entryList.Add(CreateEntryActEvent(CreateConceptDescriptor("102.15513.132.1.2", CodingSystem.NCTIS, "Response Narrative", null), CreateStructuredText(responseDetails.ResponseNarrative, null)));
            }
          ...
          if (recommendations != null)
          {
            ...
            if (recommendations.Recommendation != null && recommendations.Recommendation.Any())
            {
              foreach (var recomendation in recommendations.Recommendation)
              {
                ...
                entryList.Add(CreateEntryActEventInterval(CreateConceptDescriptor("102.20016", CodingSystem.NCTIS, "Recommendation", null),
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(List<Achievement> achievements, string sectionTitle, StrucDocText pathologyCustomNarrative, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          component = new POCD_MT000040Component3
          {
            section = new POCD_MT000040Section
            {
              code = CreateCodedWithExtensionElement(CreateCodableText(ConsumerEnteredAchievementsSections.Achievements)),
              id = CreateIdentifierElement(CreateGuid(), null),
              title = CreateStructuredText(sectionTitle, null),
              templateId = CreateIdentifierArray(ConsumerEnteredAchievementsSections.Achievements.GetAttributeValue<NameAttribute, string>(x => x.Identifier), null),
      ...
      /// <param name="narrativeGenerator">The narrative generator</param>
      /// <returns>POCD_MT000040Component3</returns>
      internal static POCD_MT000040Component3 CreateComponent(PCEHRPrescriptionItem item, IParticipationPrescriber prescriber, IParticipationPrescriberOrganisation participationPrescriberOrganisation, IParticipationSubjectOfCare subjectOfCare, INarrativeGenerator narrativeGenerator)
      {
          POCD_MT000040Component3 component = null;
          ...
          if (item != null)
          {
            component = new POCD_MT000040Component3
            {
              section = new POCD_MT000040Section
              {
                ...
                title = CreateStructuredText(EtpRecordSections.PrescriptionItem.GetAttributeValue<NameAttribute, string>(x => x.Title), null)
              }
            };
          }
          ...
          if (subjectOfCare.Participant != null && (subjectOfCare.Participant.Entitlements != null && subjectOfCare.Participant.Entitlements.Count > 0))
          {
          ...
          if (prescriber.Participant != null && (prescriber.Participant.Person != null && (prescriber.Participant != null && (prescriber.Participant.Person.Entitlements != null && prescriber.Participant.Person.Entitlements.Count > 0))))
          {
          ...
          if (participationPrescriberOrganisation != null && participationPrescriberOrganisation.Participant != null && participationPrescriberOrganisation.Participant.Organisation != null && participationPrescriberOrganisation.Participant.Entitlements != null && participationPrescriberOrganisation.Participant.Entitlements.Any())
          {
            coverages.AddRange(CreateEntitlements(participationPrescriberOrganisation.Participant.Entitlements, participationPrescriberOrganisation.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD).ToArray());
          }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(DispenseItem item, IParticipationSubjectOfCare subjectOfCare, IParticipationDispenserOrganisation dispensingOrganisation, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          if (item.QuantityToDispense != null && !item.QuantityToDispense.QuantityDescription.IsNullOrEmptyWhitespace())
          {
          ...
          if (item != null)
          {
            component = new POCD_MT000040Component3
            {
              section = CreateSectionCodeTitle(AdminCodes.DispenseItem.GetAttributeValue<NameAttribute, String>(x => x.Code), CodingSystem.NCTIS, AdminCodes.DispenseItem.GetAttributeValue<NameAttribute, String>(x => x.Name))
            };
                   ...
                   (
                       CreateEntryRelationshipACT
                           (
                               ...
                               CreateStructuredText(item.PatientCategory.GetAttributeValue<NameAttribute, String>(x => x.Name), null),
                               CreateIdentifierArray(new UniqueId())
                           )
                   );
            }
            ...
            if (item.BrandSubstituteOccurred.HasValue)
            {
              supplyEntryRelationships.Add
                  ...
                  CreateEntryRelationshipObservation
                      ...
                      CreateConceptDescriptor
                          (
                              AdminCodes.BrandSubstitutionOccurred.GetAttributeValue<NameAttribute, String>(x => x.Code),
                              CodingSystem.NCTIS,
                              AdminCodes.BrandSubstitutionOccurred.GetAttributeValue<NameAttribute, String>(x => x.Name),
                              null
                          ),
            ...
            var entryRelationship = new POCD_MT000040EntryRelationship
            {
              ...
              supply = new POCD_MT000040Supply
              {
                ...
                // QuantityToDispense
                quantity = ((item.QuantityToDispense != null) && (item.QuantityToDispense.Quantity != null)) ? new PQ
                {
                  value = item.QuantityToDispense != null && item.QuantityToDispense.Quantity != null && !item.QuantityToDispense.Quantity.Value.IsNullOrEmptyWhitespace() ? item.QuantityToDispense.Quantity.Value : null,
                  unit = item.QuantityToDispense != null && item.QuantityToDispense.Quantity != null ? item.QuantityToDispense.Quantity.Units : null
                } : null,
                product = ((item.QuantityToDispense != null && item.QuantityToDispense.Unit != null) || (item.PBSRPBSManufacturerCode != null) || (item.PBSExtemporaneousIngredient != null)) ? new POCD_MT000040Product
                {
                  manufacturedProduct = new POCD_MT000040ManufacturedProduct
                  {
                    manufacturerOrganization = item.PBSRPBSManufacturerCode == null ? null : new POCD_MT000040Organization
                    {
                      id = CreateIdentifierArray(item.PBSRPBSManufacturerCode)
                    },
                    manufacturedMaterial = new POCD_MT000040Material
                    {
                      formCode = item.QuantityToDispense != null && item.QuantityToDispense.Unit != null ? CreateConceptDescriptor(item.QuantityToDispense.Unit) : null,
                      asIngredient = CreatePBSExtemporaneousIngredient(item.PBSExtemporaneousIngredient)
                    } 
                  }
                } : null,
                // Dispense Item Id
                id = item.DispenseItemIdentifier != null ? CreateIdentifierArray(item.DispenseItemIdentifier) : CreateIdentifierArray(CreateGuid(), null),
                ...
                coverage = new[]
                {                                     // ClaimCategoryType
                                                      item.ClaimCategoryType == ClaimCategoryType.Undefined ? null : 
                                                        ...
                                                        item.EarySupplyWithPharmaceuticalBenefit.HasValue  && item.EarySupplyWithPharmaceuticalBenefit.Value ?  
                                                            CreatePolicyOrAccount
                                                                  (
                                                                      ActClass.COV, 
                                                                      ActMood.PERM, 
                                                                      ...
                                                                      CreateConceptDescriptor
                                                                      (
                                                                        AdminCodes.EarlySupplyWithPharmaceuticalBenefit.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                                                        CodingSystem.NCTIS,
                                                                        AdminCodes.EarlySupplyWithPharmaceuticalBenefit.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                                                        null
                                                                      )
                                                                   ) : null,
                                                        // Under Co-payment
                                                        item.UnderCoPayment == ClaimCategoryType.Undefined ? null : 
                                                            CreatePolicyOrAccount
                                                                  (
                                                                      ActClass.COV, 
                                                                      ActMood.PERM, 
                                                         ...
                                                         // PBS Close The Gap Benefit
                                                          item.PBSCloseTheGapBenefit == null ? null : CreatePolicyOrAccount
                                                          ( 
                                                              ActClass.COV, 
                                                              ActMood.PERM, 
                                                              ...
                                                              CreateConceptDescriptor
                                                              (
                                                                  AdminCodes.PBSCloseTheGapBenefit.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                                                  CodingSystem.NCTIS,
                                                                  AdminCodes.PBSCloseTheGapBenefit.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                                                  null
                                                               )
                                                           )
                                                  },
              ...
              // Sequence Number 
              sequenceNumber = item.NumberOfThisDispense != null ? CreateIntegerElement(item.NumberOfThisDispense.Value, NullFlavor.NA, false) : null
            ...
            {
              if (item.TherapeuticGoodIdentification != null && item.TherapeuticGoodIdentification.Translations == null)
          ...
          if (subjectOfCare != null && subjectOfCare.Participant != null && subjectOfCare.Participant.Entitlements != null && subjectOfCare.Participant.Entitlements.Count > 0)
          {
            coverages.AddRange(CreateEntitlements(subjectOfCare.Participant.Entitlements, subjectOfCare.Participant.UniqueIdentifier.ToString(), RoleClass.PAT, ParticipationType.BEN).ToArray());
          }

          // entitlements dispenser organisation
          if (dispensingOrganisation.Participant != null && dispensingOrganisation.Participant.Entitlements != null && dispensingOrganisation.Participant.Entitlements.Count > 0)
          {
            coverages.AddRange(CreateEntitlements(dispensingOrganisation.Participant.Entitlements, dispensingOrganisation.Participant.UniqueIdentifier.ToString(), RoleClass.SDLOC, ParticipationType.HLD).ToArray());
          }
        ...
        internal static POCD_MT000040Component3 CreateComponent(AustralianChildhoodImmunisationRegisterHistory australianChildhoodImmunisationRegisterHistory, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (australianChildhoodImmunisationRegisterHistory != null)
          {
            component = new POCD_MT000040Component3
            {
              section = CreateSectionCodeTitle(MedicareOverviewSections.AustralianChildhoodImmunisationRegisterHistory)
            };
            ...
            if (australianChildhoodImmunisationRegisterHistory.ExclusionStatement != null)
            {
              ...
              var section = CreateSectionCodeTitle
                            (
                                       MedicareOverviewSections.AustralianChildhoodImmunisationRegisterHistoryExclusionStatement.GetAttributeValue<NameAttribute, string>(x => x.Code),
                                       CodingSystem.NCTIS,
            ...
            if (australianChildhoodImmunisationRegisterHistory.AustralianChildhoodImmunisationRegisterEntries != null)
            {
              ...
              if (australianChildhoodImmunisationRegisterHistory.AustralianChildhoodImmunisationRegisterEntries.AustralianChildhoodImmunisationRegisterDocumentLink != null)
              {
                entries.Add(CreateEntryLink(x_DocumentActMood.EVN,
                                            CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.AustralianChildhoodImmunisationRegisterEntriesDocument)),
                                            australianChildhoodImmunisationRegisterHistory.AustralianChildhoodImmunisationRegisterEntries.AustralianChildhoodImmunisationRegisterDocumentLink));
              }

              var section = CreateSectionCodeTitle(MedicareOverviewSections.AustralianChildhoodImmunisationRegisterEntries);
                if (
                    australianChildhoodImmunisationRegisterHistory.AustralianChildhoodImmunisationRegisterEntries.AustralianChildhoodImmunisationRegisterEntry != null)
                    foreach (var australianChildhoodImmunisationRegisterEntry in australianChildhoodImmunisationRegisterHistory.AustralianChildhoodImmunisationRegisterEntries.AustralianChildhoodImmunisationRegisterEntry)
                    {
                        ...
                        {
                            entryRelationship = australianChildhoodImmunisationRegisterEntry.VaccineCancellationReason.Select(CreateVaccineCancellationReason).ToList();
                        }
                ...
                section.text = australianChildhoodImmunisationRegisterHistory.AustralianChildhoodImmunisationRegisterEntries.CustomNarrative ?? narrativeGenerator.CreateNarrative(australianChildhoodImmunisationRegisterHistory);
              section.entry = entries.ToArray();
        ...
        internal static POCD_MT000040Component3 CreateComponent(AustralianOrganDonorRegisterDecisionInformation australianOrganDonorRegisterDecisionInformation, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (australianOrganDonorRegisterDecisionInformation != null)
          {
            ...
            if (australianOrganDonorRegisterDecisionInformation.ExclusionStatement != null)
            {
              ...
              var section = CreateSectionCodeTitle
                            (
                                       MedicareOverviewSections.AustralianOrganDonorRegisterDetailsExclusionStatement.GetAttributeValue<NameAttribute, string>(x => x.Code),
                                       CodingSystem.NCTIS,
            ...
            if (australianOrganDonorRegisterDecisionInformation.AustralianOrganDonorRegisterDetails != null)
            {
              ...
              if (australianOrganDonorRegisterDecisionInformation.AustralianOrganDonorRegisterDetails != null)
              {
                ...
                if (australianOrganDonorRegisterDecisionInformation.AustralianOrganDonorRegisterDetails.AustralianOrganDonorRegisterDetailsDocumentLink != null)
                {
                  entryList.Add(CreateEntryLink(x_DocumentActMood.EVN,
                                                CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.AustralianOrganDonorRegisterDetailsDocumentLink)),
                                                australianOrganDonorRegisterDecisionInformation.AustralianOrganDonorRegisterDetails.AustralianOrganDonorRegisterDetailsDocumentLink));
                }
              }
      ...
      /// <param name="narrativeGenerator">The narrative generator</param>
      /// <returns>POCD_MT000040Component3</returns>
      internal static POCD_MT000040Component3 CreateComponent(IEPrescriptionItem item, IParticipationPrescriber prescriber, IParticipationPrescriberOrganisation participationPrescriberOrganisation, IParticipationSubjectOfCare subjectOfCare, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          var entries = new List<POCD_MT000040Entry>();
          ...
          if (item != null)
          {
            component = new POCD_MT000040Component3
            {
              section = CreateSectionCodeTitle(ATSEtpRecordSection.PrescriptionItem.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                               CodingSystem.NCTIS,
                   ...
                   new POCD_MT000040Author
                       {
                           ...
                           assignedAuthor = prescriber.Participant == null ? null :  new POCD_MT000040AssignedAuthor
                                            {
                  ...
                  (
                      CreateEntryObservationLegacy
                          (
                              ...
                              CreateConceptDescriptor
                                  (
                                      ATSEtpRecordSection.DateTimePrescriptionExpires.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                      CodingSystem.NCTIS,
                                      ATSEtpRecordSection.DateTimePrescriptionExpires.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                      null
                                  ),
            ...
            var entryRelationship = new POCD_MT000040EntryRelationship
            {
              ...
              {
                moodCode = x_DocumentSubstanceMood.RQO,
                quantity = item.QuantityToDispense != null && (item.QuantityToDispense.Quantity != null || item.QuantityToDispense.Unit != null) ? new PQ
                {
                  value = item.QuantityToDispense != null && item.QuantityToDispense.Quantity != null && !item.QuantityToDispense.Quantity.Value.IsNullOrEmptyWhitespace() ? item.QuantityToDispense.Quantity.Value : null,
                  unit = item.QuantityToDispense != null && item.QuantityToDispense.Quantity != null ? item.QuantityToDispense.Quantity.Units : null
                } : null,
                product = ((item.QuantityToDispense != null && item.QuantityToDispense.Unit != null) || (item.PBSRPBSManufacturerCode != null)) ? new POCD_MT000040Product
                {
                  manufacturedProduct = new POCD_MT000040ManufacturedProduct
                  {
                    manufacturerOrganization = item.PBSRPBSManufacturerCode == null ? null : new POCD_MT000040Organization
                ...
                effectiveTime = item.MinimumIntervalBetweenRepeats == null ? null : new[]
                                       {
                                                  ...
                                                  period = new PQ
                                                             {
                                                                  ...
                                                                  value = !item.MinimumIntervalBetweenRepeats.Value.IsNullOrEmptyWhitespace() ? item.MinimumIntervalBetweenRepeats.Value : null,
                                                             }
                                              }
                                       },
                ...
                coverage = new[]
                            {
                              ...
                              item.PBSPrescriptionType.HasValue ? CreatePolicyOrAccount
                              (
                                  ActClass.COV, 
                                  ActMood.PERM, 
                                  null as string, 
                              ...
                              item.MedicalBenefitCategoryType.HasValue ? CreatePolicyOrAccount
                              (
                                  ActClass.COV, 
                                  ActMood.PERM, 
                                  null as string, 
                                  CreateConceptDescriptor
                                  (
                                      item.MedicalBenefitCategoryType.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                      item.MedicalBenefitCategoryType.GetAttributeValue<NameAttribute, String>(x => x.Version),
                                      CodingSystem.NCTISMedicalBenefitCategoryTypeValues.GetAttributeValue<NameAttribute, String>(x => x.Name),
                             ...
                             // PBS RPBS Authority Approval Number
                              item.PBSRPBSAuthorityApprovalNumber == null ? null : CreatePolicyOrAccount
                              ( 
                                  ActClass.COV, 
                                  ActMood.PERM, 
                                  new Identifier { Root = "1.2.36.1.5001.1.1.3.2.3", Extension = item.PBSRPBSAuthorityApprovalNumber }, 
                                  CreateConceptDescriptor
                                  (
                                      AdminCodes.PBSRPBSAuthorityApprovalNumber.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                      CodingSystem.NCTIS,
                                      AdminCodes.PBSRPBSAuthorityApprovalNumber.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                      null
                                   )
                               )
                            },
                entryRelationship = item.QuantityToDispense != null && !item.QuantityToDispense.QuantityDescription.IsNullOrEmptyWhitespace() ? new[]
                                  {
                                     CreateEntryRelationshipACT
                                    (
                                        x_ActRelationshipEntryRelationship.COMP,
                  ...
                  (
                      CreateEntryRelationshipACT
                          (
                              ...
                              CreateConceptDescriptor
                                  (
                                      ATSEtpRecordSection.ReasonForTherapeuticGood.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                      CodingSystem.NCTIS,
                                      ATSEtpRecordSection.ReasonForTherapeuticGood.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                      null
                                  ),
              ...
              relationships.Add(
                  CreateEntryRelationshipACT
                      (
                          ...
                          CreateConceptDescriptor
                              (
                                  ATSEtpRecordSection.AdditionalComments.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                  CodingSystem.NCTIS,
                                  ATSEtpRecordSection.AdditionalComments.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                  null
                              ),
                          CreateStructuredText(item.AdditionalComments, null),
            ...
            {
              // Start Criterion
              if (item.Timing.StopCriterion.HasValue && item.Timing.StopCriterion.Value || item.Timing.StartDate != null)
              {
                relationships.Add(
                    CreateEntryRelationshipControlAct(
                        ...
                        CreateConceptDescriptor
                            (
                                ATSEtpRecordSection.StartCriterion.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                CodingSystem.NCTIS,
                                ATSEtpRecordSection.StartCriterion.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                null
                            ),
                         null,
                         null,
              ...
              // Stop Criterion
              if (item.Timing.StopCriterion.HasValue && item.Timing.StopCriterion.Value || item.Timing.StopDate != null)
              {
                relationships.Add(
                    CreateEntryRelationshipControlAct(
                        x_ActRelationshipEntryRelationship.COMP,
                        ...
                        CreateConceptDescriptor
                            (
                                ATSEtpRecordSection.StopCriterion.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                CodingSystem.NCTIS,
                                ATSEtpRecordSection.StopCriterion.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                null
                            ),
                         null,
                         null,
            ...
            if (item.Timing != null && item.Timing.StructuredTiming != null && item.Timing.StructuredTiming.EffectiveTime != null)
            ...
            if (item.GroundsForConcurrentSupply != GroundsForConcurrentSupply.Undefined || item.StateAuthorityNumber != null || item.PBSRPBSAuthorityPrescriptionNumber != null || item.StreamlinedAuthorityApprovalNumber != null)
              entry.substanceAdministration.consumable.manufacturedProduct.subjectOf1 = new[]
                    {
                    // GroundsForConcurrentSupply
                    item.GroundsForConcurrentSupply == GroundsForConcurrentSupply.Undefined ? null : CreatePolicy
                              (
                                    ActClass.JURISPOL, 
                                    ActMood.PERM, 
                                    null as string,
                                    CreateConceptDescriptor
                                                 (
                                                    item.GroundsForConcurrentSupply.GetAttributeValue<NameAttribute, String>(x => x.Code),
                  ...
                  item.StateAuthorityNumber != null ?  CreatePolicy
                              (
                                    ActClass.JURISPOL, 
                                    ActMood.PERM,
                                    ...
                                    CreateConceptDescriptor
                                             (
                                                ATSEtpRecordSection.StateAuthorityNumber.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                                CodingSystem.NCTIS,
                                                ATSEtpRecordSection.StateAuthorityNumber.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                                null
                                             )
                              ) : null,
               // PBS RPBS Authority Prescription Number
                item.PBSRPBSAuthorityPrescriptionNumber == null ? null : CreatePolicy
                            ( 
                                ActClass.JURISPOL, 
                                ActMood.PERM, 
                                new Identifier { Root = "1.2.36.1.5001.1.1.3.2.2", Extension = item.PBSRPBSAuthorityPrescriptionNumber }, 
                                CreateConceptDescriptor
                                (
                                    AdminCodes.PBSRPBSAuthorityPrescriptionNumber.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                    CodingSystem.NCTIS,
                                    AdminCodes.PBSRPBSAuthorityPrescriptionNumber.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                    null
                                 )
                             ),

               // Streamlined Authority Approval Number
                item.StreamlinedAuthorityApprovalNumber == null ? null : CreatePolicy
                            ( 
                                ActClass.JURISPOL, 
                                ActMood.PERM, 
                                new Identifier { Root = "1.2.36.1.2001.1005.24", Extension = item.StreamlinedAuthorityApprovalNumber }, 
                                CreateConceptDescriptor
                                (
                                    AdminCodes.StreamlinedAuthorityApprovalNumber.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                    CodingSystem.NCTIS,
                                    AdminCodes.StreamlinedAuthorityApprovalNumber.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                    null
                                 )
                             ),
                        };
            ...
            if (!item.NoteDetail.IsNullOrEmptyWhitespace())
              ...
              (
                          ...
                          (
                              ...
                              CreateConceptDescriptor
                                  (
                                      ATSEtpRecordSection.PrescriptionNoteDetail.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                      CodingSystem.NCTIS,
                                      ATSEtpRecordSection.PrescriptionNoteDetail.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                      null
                                  ),
                              item.NoteDetail,
                              null,
            ...
            component.section.text = item.CustomNarrative ?? narrativeGenerator.CreateNarrative(item, prescriber, subjectOfCare);
          }
                                                                ...
                                                                INarrativeGenerator narrativeGenerator)
        {
          ...
          if (prescriberInstructionDetail != null)
          {
              ...
              relationshipList.Add
                  (
                      ...
                      (
                          ...
                          CreateConceptDescriptor
                          (
                              AdminCodes.PrescriberInstructionSource.GetAttributeValue<NameAttribute, String>(x => x.Code),
                              CodingSystem.NCTIS,
                              AdminCodes.PrescriberInstructionSource.GetAttributeValue<NameAttribute, String>(x => x.Name),
                              null
                          ),
                          new List<ANY>
                                    {
                                        CreateConceptDescriptor
                                            ...
                                            null,
                                            null,
                                            prescriberInstructionDetail.PrescriberInstructionSource.GetAttributeValue<NameAttribute, String>(x => x.Name))
                                    }
                      )
                  );
            }
              ...
              relationshipList.Add
                  (
                      ...
                      (
                          ...
                          CreateConceptDescriptor
                          (
                              AdminCodes.PrescriberInstructionCommunicationMedium.GetAttributeValue<NameAttribute, String>(x => x.Code),
                              CodingSystem.NCTIS,
                              AdminCodes.PrescriberInstructionCommunicationMedium.GetAttributeValue<NameAttribute, String>(x => x.Name),
                              null
                          ),
                          new List<ANY>
                                    {
                                        CreateConceptDescriptor
                                            ...
                                            null,
                                            null,
                                            prescriberInstructionDetail.PrescriberInstructionCommunicationMedium.GetAttributeValue<NameAttribute, String>(x => x.Name))
                                    }
                      )
                  );
            }
            ...
            if (participationPrescriber != null && participationPrescriber.Participant != null && participationPrescriber.Participant.Person != null && participationPrescriber.Participant.Person.Entitlements != null && participationPrescriber.Participant.Person.Entitlements.Any())
            {
              coverages.AddRange(CreateEntitlements(participationPrescriber.Participant.Person.Entitlements, participationPrescriber.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD).ToArray());
            }
            ...
            component.section.text = narrativeGenerator.CreateNarrative(prescriberInstructionDetail, participationPrescriber, participationPrescriberOrganisation);
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(PrescriptionRequestItem item, IParticipationSubjectOfCare subjectOfCare, IParticipationDispenserOrganisation dispensingOrganisation, String requesterNote, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          var entries = new List<POCD_MT000040Entry>();
          ...
          if (item != null)
          {
            component = new POCD_MT000040Component3
                          {
                            section = CreateSectionCodeTitle(
                                ATSEtpRecordSection.PrescriptionRequestItem.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                CodingSystem.NCTIS,
                                ATSEtpRecordSection.PrescriptionRequestItem.GetAttributeValue<NameAttribute, String>(x => x.Name))
                          };
            ...
            var entryRelationship = new POCD_MT000040EntryRelationship
                                      {
                                        ...
                                        supply = new POCD_MT000040Supply
                                                   {
                                                     moodCode = x_DocumentSubstanceMood.RQO,
               quantity = item.QuantityToDispense == null || item.QuantityToDispense.Quantity == null ? null : new PQ
                {
                  value = item.QuantityToDispense != null && item.QuantityToDispense.Quantity != null && !item.QuantityToDispense.Quantity.Value.IsNullOrEmptyWhitespace() ? item.QuantityToDispense.Quantity.Value : null,
                  unit = item.QuantityToDispense != null && item.QuantityToDispense.Quantity != null ? item.QuantityToDispense.Quantity.Units : null
                },
                ...
                coverage = new[]
                            {
                             ...
                             // PBS RPBS Authority Approval Number
                              ...
                              // PBS RPBS Authority Prescription Number
                              item.PBSRPBSAuthorityPrescriptionNumber == null ? null : CreatePolicyOrAccount
                              ( 
                                ActClass.COV, 
                                ActMood.PERM, 
                                new Identifier { Root = "1.2.36.1.5001.1.1.3.2.2", Extension = item.PBSRPBSAuthorityPrescriptionNumber }, 
                            ...
                            // Streamlined Authority Approval Number
                              item.StreamlinedAuthorityApprovalNumber == null ? null : CreatePolicyOrAccount
                                          ( 
                                              ActClass.COV, 
                                              ActMood.PERM, 
                                              new Identifier { Root = "1.2.36.1.2001.1005.24", Extension = item.StreamlinedAuthorityApprovalNumber }, 
            ...
            // entitlements dispenser organisation
            if (dispensingOrganisation != null && dispensingOrganisation.Participant != null && dispensingOrganisation.Participant.Entitlements != null && dispensingOrganisation.Participant.Entitlements.Count > 0)
            {
              coverages.AddRange(CreateEntitlements(dispensingOrganisation.Participant.Entitlements, dispensingOrganisation.Participant.UniqueIdentifier.ToString(), RoleClass.SDLOC, ParticipationType.HLD).ToArray());
            }
            ...
            component.section.text = item.CustomNarrative ?? narrativeGenerator.CreateNarrative(item, subjectOfCare, dispensingOrganisation, requesterNote);
          }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(IObservationWeightHeight observation, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(PCEHRDispenseItem item, IParticipationDispenser dispenser, IParticipationDispenserOrganisation dispenserOrganisation, IParticipationSubjectOfCare subjectOfCare, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          var entries = new List<POCD_MT000040Entry>();
          ...
          if (item != null)
          {
            component = new POCD_MT000040Component3
            {
              section = new POCD_MT000040Section
              {
                ...
                title = CreateStructuredText(EtpRecordSections.DispenseItem.GetAttributeValue<NameAttribute, string>(x => x.Title), null)
              }
            };
            ...
            // Entitlements Participation Prescriber
            if (dispenserOrganisation.Participant != null && (dispenserOrganisation.Participant.Entitlements != null && dispenserOrganisation.Participant.Entitlements.Count > 0))
            {
        ...
        private static POCD_MT000040Component4 CreateComponentObservation(CD code, List<ANY> any, string textReferance, II[] identifier, II[] templateId)
        {
          var component = new POCD_MT000040Component4
          {
            observation =
              new POCD_MT000040Observation
              {
                ...
                text = !textReferance.IsNullOrEmptyWhitespace() ? new ED
                {
                  reference = new TEL
                  {
                    value = textReferance
        ...
        internal static POCD_MT000040Component5[] CreateComponent(IList<IDiagnosticImagingExaminationResult> imagingExaminationResults, INarrativeGenerator narrativeGenerator)
        {
                ...
                foreach (var imagingExaminationResult in imagingExaminationResults)
                {
                    ...
                    if (!imagingExaminationResult.ExaminationProcedure.IsNullOrEmptyWhitespace())
                    {
                        ...
                        relationshipList.Add(CreateEntryRelationshipACT(
                            ...
                            x_DocumentActMood.EVN,
                            null, 
                            CreateConceptDescriptor(CreateCodableText(DiagnosticImagingReportSections.ExaminationProcedure)),
                    ...
                    if (imagingExaminationResult.OverallResultStatus != null)
                        relationshipList.Add(CreateRelationshipForTestResultStatus(imagingExaminationResult.OverallResultStatus));

                    if (imagingExaminationResult.RelatedImage != null)
                    {
                        var relatedImages = CreateEntryRelationshipACT(x_ActClassDocumentEntryAct.ACT,
                            x_DocumentActMood.EVN,
                            CreateConceptDescriptor(CreateCodableText(DiagnosticImagingReportSections.RelatedInformation)),
                            null, null);

                        relatedImages.typeCode = x_ActRelationshipEntryRelationship.COMP;
                        relatedImages.act.reference = CreatesReferanceLink(imagingExaminationResult.RelatedImage.ImageUrl, imagingExaminationResult.RelatedImage.MediaType);
                    ...
                    if (imagingExaminationResult.ExaminationDetails != null)
                    {
                        ...
                        POCD_MT000040EntryRelationship imageDetails =
                            CreateEntryRelationshipObservation(
                                ...
                                CreateConceptDescriptor(CreateCodableText(DiagnosticImagingReportSections.ImageDetails)),
                                null, 
                                null, 
                                null, 
                                null);
                    ...
                    {
                        relationshipList.Add(CreateRelationshipForDateTime(imagingExaminationResult.ObservationDateTime));
                    }

                    if (imagingExaminationResult.AnatomicalSite != null)
                    {
                        relationshipList.Add(CreateAnatomicalRegionRelationship(imagingExaminationResult.AnatomicalRegion));
                    }

                    // Create the observation entry with all the above relationships nested inside the observation
                    entryList.Add(
                        CreateEntryObservation(x_ActRelationshipEntry.COMP,
                        imagingExaminationResult.ExaminationResultName != null ? CreateConceptDescriptor(imagingExaminationResult.ExaminationResultName) : null,
                        imagingExaminationResult.Modality != null ? new[]
                        {
                            CreateCodedWithExtensionElement(imagingExaminationResult.Modality)
                        } : null,
                        imagingExaminationResult.AnatomicalSite != null && imagingExaminationResult.AnatomicalSite.Any() ?  
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component5</returns>
        internal static POCD_MT000040Component5[] CreateComponent(IList<SCSModel.Pathology.PathologyTestResult> pathologyTestResults,  INarrativeGenerator narrativeGenerator)
        {
            ...
            if (pathologyTestResults.Any())
            {
             ...
             foreach (var pathologyTestResult in pathologyTestResults)
             {
                ...
                if (pathologyTestResult.TestResultName != null)
                {
                  ...
                  if (pathologyTestResult.PathologyDiscipline.HasValue)
                  {
                      entryRelationships.Add(CreateEntryRelationshipObservation(
                         x_ActRelationshipEntryRelationship.COMP,
                         false,
                         CreateConceptDescriptor(CreateCodableText(PatholodyResultReportSections.PathologyService)),
                         new List<ANY>
                         {
                              CreateConceptDescriptor(CreateCodableText(pathologyTestResult.PathologyDiscipline.Value))
                         }
                        ));
                  }
                  ...
                  if (pathologyTestResult.OverallTestResultStatus != null)
                  {
                      entryRelationships.Add(CreateEntryRelationshipObservation(
                         x_ActRelationshipEntryRelationship.COMP,
                         false,
                         CreateConceptDescriptor(CreateCodableText(PatholodyResultReportSections.OverallTestResultStatus)),
                         new List<ANY>
                         {
                  ...
                  if (pathologyTestResult.TestSpecimenDetail != null)
                  entryRelationships.Add(CreateEntryRelationshipObservation(x_ActRelationshipEntryRelationship.SUBJ,
                                                     ActClassObservation.OBS,
                                                     x_ActMoodDocumentObservation.EVN, 
                                                     null,
                  ...
                  if (pathologyTestResult.ObservationDateTime != null)
                  {
                    entryRelationships.Add(CreateEntryRelationshipObservation(
                      ...
                      CreateConceptDescriptor(CreateCodableText(PatholodyResultReportSections.PathologyTestResultDateTime)),
                      null));
                  }
                ...
                {
                    pathologyTestResultComponent.section.text = pathologyTestResult.CustomNarrative ?? narrativeGenerator.CreateNarrative(pathologyTestResult);
                }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component5</returns>
        internal static POCD_MT000040Component5[] CreateComponent(IList<SCSModel.Pathology.RequestedService> requestedServices, INarrativeGenerator narrativeGenerator)
        {
                ...
                foreach (var requestedService in requestedServices)
                {
                    ...
                    if (requestedService.RequestedServiceDateTime != null)
                    {
                        entryRelationships.Add(CreateEntryRelationshipACT(
                          ...
                          x_DocumentActMood.EVN,
                          false,
                          CreateConceptDescriptor(CreateCodableText(PatholodyResultReportSections.RequestedServiceDateTime)),
                          null,
                          null,
                    ...
                    if (requestedService.RequestedServiceDescription != null && requestedService.ServiceBookingStatus.HasValue)
                    {
                        requestedServiceEntryList.Add(
                          CreateEntryActEvent
                            (
                              ...
                              x_ActClassDocumentEntryAct.ACT,
                              ((x_DocumentActMood)Enum.Parse(typeof(x_DocumentActMood), requestedService.ServiceBookingStatus.GetAttributeValue<NameAttribute, string>(x => x.Code))),
                    ...
                    {
                        requestedServiceComponent.section.author = new[] { CreateAuthor(requestedService.ServiceRequester) };
                    }
                    ...
                    {
                        requestedServiceComponent.section.text = requestedService.CustomNarrative ?? narrativeGenerator.CreateNarrative(requestedService);
                    }
        ...
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(AuthorityToPost authorityToPost, ICodableText reportStudy, INarrativeGenerator narrativeGenerator)
        {
            ...
            if (authorityToPost != null)
            {
                ...
                entry.observation.reference = new []
                            {
                                // Report Identifier
                                authorityToPost.ReportIdentifier != null ? new POCD_MT000040Reference
                                {
                                    typeCode = x_ActRelationshipExternalReference.REFR,
                                    externalDocument = new POCD_MT000040ExternalDocument
                                    {
                                ...
                                // Report Identifier
                                authorityToPost.ServiceRequestIdentifier != null && authorityToPost.ServiceRequestIdentifierCode != null  ? new POCD_MT000040Reference
                                {
                                    typeCode = x_ActRelationshipExternalReference.REFR,
                                    externalDocument = new POCD_MT000040ExternalDocument
                                    {
                ...
                if (authorityToPost.Authoriser != null)
                {
                    ...
                    // Entitlements
                    if (authorityToPost.Authoriser.Participant != null && authorityToPost.Authoriser.Participant.Entitlements != null && authorityToPost.Authoriser.Participant.Entitlements.Any())
                    {
                        authorityToPostComponent.section.coverage2 = CreateEntitlements(authorityToPost.Authoriser.Participant.Entitlements, authorityToPost.Authoriser.Participant.UniqueIdentifier.ToString(), RoleClass.ASSIGNED, ParticipationType.HLD).ToArray();
                    }
                }
                ...
                {
                    authorityToPostComponent.section.text = authorityToPost.CustomNarrative ?? narrativeGenerator.CreateNarrative(authorityToPost);
                }
        ...
        internal static POCD_MT000040Component5 CreateOtherTestResult(OtherTestResult otherTestResult, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (otherTestResult.ReportStatus != null)
            relationshipList.Add(CreateRelationshipForTestResultStatus(otherTestResult.ReportStatus));

          // External Data

          // NOTE: This fails schematron when the included value is missing and only the observation media is provided.
          //       Therefore the EncapsulatedData needs to be included in two locations the value and observation media.
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component5 CreateComponent(IPCEHRPrescriptionItemView item, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (item != null)
          {
            ...
            entries.Add(CreateEntryLink(x_DocumentActMood.EVN, CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.PrescriptionRecordLink)), item.PrescriptionRecordLink));

            component.section.entry = entries.ToArray();
            component.section.text = item.CustomNarrativePrescriptionItem ?? narrativeGenerator.CreateNarrative(item as PCEHRPrescriptionItem, null, null);
          }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component5 CreateComponent(PCEHRDispenseItem item, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component5 component = null;
          var entries = new List<POCD_MT000040Entry>();
          ...
          if (item != null)
          {
            ...
            entries.Add(CreateEntryLink(x_DocumentActMood.EVN, CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.DispenseRecordLink)), item.DispenseRecordLink));

            // Add component entry array
            component.section.entry = entries.ToArray();
            component.section.text = item.CustomNarrativeDispenseItem ?? narrativeGenerator.CreateNarrative(item, null, null, null);
          }
          return component;
        }
            ...
            if (requestedServices != null && requestedServices.Any())
            {
                foreach (var requestedService in requestedServices)
                {
                    ...
                    if (requestedService.ServiceProvider != null)
                    {
                        ...
                        {
                            component.section.coverage2 = CreateEntitlements(requestedService.ServiceProvider.Participant.Person.Entitlements, 
                    ...
                    if (requestedService.RequestedServiceDateTime != null)
                    {
                        relationshipList.Add(CreateEntryRelationshipACT(x_ActRelationshipEntryRelationship.COMP,
                                                                        x_ActClassDocumentEntryAct.ACT,
                                                                        x_DocumentActMood.EVN, false,
                                                                        CreateConceptDescriptor("103.16635", CodingSystem.NCTIS, "Requested Service DateTime", null),
                                                                        null, null,
                                                                        requestedService.RequestedServiceDateTime));
                    }
                  ...
                  representedCustodianOrganization =
                      new POCD_MT000040CustodianOrganization
                      {
                        ...
                        asEntityIdentifier =
                            ...
                            custodian.Participant.Organisation.Identifiers == null ? null : CreateEntityIdentifier(custodian.Participant.Organisation.Identifiers).ToArray(),
        ...
        internal static POCD_MT000040LegalAuthenticator CreateLegalAuthenticator(IParticipationLegalAuthenticator authenticator)
        {
          ...
          {
            time = authenticator.Participant == null || authenticator.Participant.DateTimeAuthenticated == null ? null : CreateTimeStampElementIso(authenticator.Participant.DateTimeAuthenticated),
            ...
            assignedEntity =
                new POCD_MT000040AssignedEntity
                {
                  ...
                  telecom = authenticator.Participant == null ? null : CreateTelecomunicationArray(authenticator.Participant.ElectronicCommunicationDetails),
                  assignedPerson = authenticator.Participant != null && authenticator.Participant.Person != null && (authenticator.Participant.Person.Identifiers != null || authenticator.Participant.Person.PersonNames != null) ? new POCD_MT000040Person
                  {   
                  // PersonName
          ...
          {
            cdaAuthenticator.assignedEntity.representedOrganization = CreateOrganisation(authenticator.Participant.Organisation);
          }
        ...
        internal static POCD_MT000040Author CreateAuthor(IParticipationPrescriber prescriber, IParticipationPrescriberOrganisation prescriberOrganisation)
        {
          ...
          if (prescriber != null && prescriber.Participant != null)
          {
            ...
            returnAuthor.assignedAuthor = new POCD_MT000040AssignedAuthor { id = CreateIdentifierArray(prescriber.Participant.UniqueIdentifier.ToString(), null) };

            returnAuthor.time = prescriber.Time != null ? returnAuthor.time = CreateTimeStampElementIso(prescriber.Time) : returnAuthor.time = CreateTimeStampElementIso(NullFlavor.NA);
                                   ...
                                   new Employment
                                   {
                                     jobCode =
                                        CreateCodedWithExtensionElement(
                                            ...
                                            CodingSystem.ANZSCO,
                                            author.Person.Occupation.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null, null)
                                   } : null,
              asQualifications = author.Person != null && author.Person.Qualifications != null ? CreateQualifications(author.Person.Qualifications) : null
            };
          ...
          if (prescriberOrganisation != null && prescriberOrganisation.Participant != null)
          {
            returnAuthor.assignedAuthor.representedOrganization = new POCD_MT000040Organization
            {
              ...
              // Department Name
              name = prescriberOrganisation.Participant.Organisation == null ? null : new[] 
              ...
              // Role
              standardIndustryClassCode = prescriberOrganisation.Role != null ? CreateCodedWithExtensionElement(prescriberOrganisation.Role) : null,
              asOrganizationPartOf = new POCD_MT000040OrganizationPartOf
              {
                wholeOrganization = new POCD_MT000040Organization
                {
                  // Organisation Name
                  name = prescriberOrganisation.Participant.Organisation == null ? null : CreateOrganisationNameArray
                    (
                          prescriberOrganisation.Participant.Organisation.Name,
                          prescriberOrganisation.Participant.Organisation.NameUsage
                    ),
                  // Identifiers
                  asEntityIdentifier = prescriberOrganisation.Participant.Organisation != null && prescriberOrganisation.Participant.Organisation.Identifiers != null ?
                                       CreateEntityIdentifier(prescriberOrganisation.Participant.Organisation.Identifiers).ToArray() : null,
                  // Address
                  addr = CreateAddressArray(prescriberOrganisation.Participant.Addresses),
                  // ElectronicCommunicationDetails
                  telecom = CreateTelecomunicationArray(prescriberOrganisation.Participant.ElectronicCommunicationDetails)
                }
              }
            };
          }
        ...
        internal static POCD_MT000040Author CreateAuthor(IParticipationConsumerAuthor participationAuthor, Guid? subjectOfCareIdentifier)
        {
          ...
          if (participationAuthor != null && participationAuthor.Participant != null)
          {
            ...
            {
              returnAuthor.time = CreateTimeStampElementIso(participationAuthor.AuthorParticipationPeriodOrDateTimeAuthored);
            }
            else
            {
            ...
            returnAuthor.assignedAuthor = new POCD_MT000040AssignedAuthor { id = subjectOfCareIdentifier.HasValue ? CreateIdentifierArray(subjectOfCareIdentifier.ToString(), null) : CreateIdentifierArray(CreateGuid(), null) };
        ...
        internal static POCD_MT000040Participant2 CreateDeviceParticipant(Device device)
        {
          ...
          if (device != null)
          {
            participant.participantRole = new POCD_MT000040ParticipantRole { id = CreateIdentifierArray(CreateGuid(), null) };

            participant.typeCode = ParticipationType.DEV;

            if (device.Role != null) participant.participantRole.code = CreateCodedWithExtensionElement(device.Role);

            participant.participantRole.playingDevice = new POCD_MT000040Device
            {
              softwareName = !device.SoftwareName.IsNullOrEmptyWhitespace() ? new SC { Text = new[] { device.SoftwareName } } : null
            };
          }
        ...
        internal static POCD_MT000040Author CreateDevice(InformationProviderDevice device)
        {
          ...
          if (device != null)
          {
            ...
            if (device.Role != null) returnAuthor.assignedAuthor.code = CreateCodedWithExtensionElement(device.Role);
        ...
        internal static POCD_MT000040Author CreateAuthor(IParticipationAuthorPerson participation)
        {
          ...
          if (participation != null && participation.Participant != null)
          {
            ...
            {
                castedParticipation.AuthorParticipationPeriodOrDateTimeAuthored = participation.AuthorParticipationPeriodOrDateTimeAuthored.Value;
                castedParticipation.ParticipationPeriod = participation.AuthorParticipationPeriodOrDateTimeAuthored.Interval;
            }
        ...
        internal static POCD_MT000040Author CreateAuthor(IParticipationAuthorHealthcareProvider participation)
        {
          ...
          if (participation != null && participation.Participant != null)
          {
            ...
            if (participation.AuthorParticipationPeriodOrDateTimeAuthored != null && participation.AuthorParticipationPeriodOrDateTimeAuthored.Interval != null)
                castedParticipation.ParticipationPeriod = participation.AuthorParticipationPeriodOrDateTimeAuthored.Interval;

            if (participation.AuthorParticipationPeriodOrDateTimeAuthored != null && participation.AuthorParticipationPeriodOrDateTimeAuthored.Value != null)
                castedParticipation.AuthorParticipationPeriodOrDateTimeAuthored = participation.AuthorParticipationPeriodOrDateTimeAuthored.Value;
            ...
            if (participation.Participant.Person != null)
              returnParticipant = CreateAuthor(castedParticipation, participation.Participant.Person.Qualifications);
          }
        ...
        /// <returns>POCD_MT000040Participant1</returns>
        internal static POCD_MT000040Author CreateAuthor(IParticipationInformationProviderHealthcareProvider participation)
        {
        ...
        /// <returns>POCD_MT000040Participant1</returns>
        internal static POCD_MT000040Author CreateAuthor(IParticipationInformationProviderNonHealthcareProvider participation)
        {
          POCD_MT000040Author returnParticipant = null;
        ...
        internal static POCD_MT000040Author CreateAuthor(IParticipation participation, string qualifications)
        {
          ...
          if (participation != null && participation.Participant != null)
          {
              ...
              if (participation.AuthorParticipationPeriodOrDateTimeAuthored != null)
              {
                  participationPeriod = CreateIntervalTimestamp(participation.AuthorParticipationPeriodOrDateTimeAuthored, null);
              }
            ...
            returnInformationProvider.assignedAuthor = new POCD_MT000040AssignedAuthor { id = CreateIdentifierArray(participation.Participant.UniqueIdentifier.ToString(), null) };
            ...
            returnInformationProvider.assignedAuthor.telecom = CreateTelecomunicationArray(author.ElectronicCommunicationDetails);
            ...
            if (author.Person != null && author.Person.Identifiers != null)
            {
              returnInformationProvider.assignedAuthor.assignedPerson.asEntityIdentifier = CreateEntityIdentifier(author.Person.Identifiers).ToArray();
            }

            if (participation.Participant.Person != null && !qualifications.IsNullOrEmptyWhitespace())
            {
              returnInformationProvider.assignedAuthor.assignedPerson.asQualifications = CreateQualifications(qualifications);
            }

            if (participation.Participant.Person != null && participation.Participant.Person.Organisation != null)
            {
              returnInformationProvider.assignedAuthor.assignedPerson.asEmployment = CreateEmployment(participation.Participant.Person.Organisation);
            }
          }
        ...
        internal static POCD_MT000040Author CreateAuthor(IParticipationDocumentAuthor participationAuthor)
        {
          ...
          if (participationAuthor != null && participationAuthor.Participant != null)
          {
            ...
            if (participationAuthor.Participant.Person != null)
            {
              ...
              {
                returnAuthor.assignedAuthor.assignedPerson.asEmployment = CreateEmployment(participationAuthor.Participant.Person.Organisation);
              }
            }

            if (!participationAuthor.Participant.Qualifications.IsNullOrEmptyWhitespace())
            {
                returnAuthor.assignedAuthor.assignedPerson.asQualifications = CreateQualifications(participationAuthor.Participant.Qualifications);
            }
        ...
        internal static POCD_MT000040Author CreateAuthor(IParticipationDispenser participationAuthor)
        {
          ...
          if (participationAuthor != null && participationAuthor.Participant != null)
          {
            ...
            returnAuthor.time = participationAuthor.Time != null ? CreateTimeStampElementIso(participationAuthor.Time) : CreateTimeStampElementIso(NullFlavor.NA);
        ...
        /// <returns>POCD_MT000040Author</returns>
        internal static POCD_MT000040Author CreateInformationProvider(IParticipationInformationProvider informationProvider)
        {
          var returnInformationProvider = new POCD_MT000040Author();
          ...
          if (informationProvider != null && informationProvider.Participant != null)
          {
            ...
            returnInformationProvider.assignedAuthor = new POCD_MT000040AssignedAuthor { id = CreateIdentifierArray(CreateGuid(), null) };
            ...
            {
              returnInformationProvider.assignedAuthor.code = CreateCodedWithExtensionElement(informationProvider.Role);
            }
        ...
        /// <returns>POCD_MT000040Author</returns>
        internal static POCD_MT000040Author CreateInformationProvider(IInformationProviderCollection informationProvider)
        {
          var participationAuthor = new POCD_MT000040Author();
        ...
        internal static POCD_MT000040RecordTarget CreateSubjectOfCare(IParticipationSubjectOfCare subjectOfCareParticipation)
        {
              ...
              if (subjectOfCare.Person != null)
              {
                patient.patientRole.patient = new POCD_MT000040Patient
                {
                  ...
                  administrativeGenderCode = subjectOfCare.Person.Gender != null ? CreateCodedWithExtensionElement(
                              ...
                              CodingSystem.Gender,
                              subjectOfCare.Person.Gender.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null,
                              null) : null,
                ...
                if (subjectOfCare.Person.IndigenousStatus != IndigenousStatus.Undefined)
                {
                  patient.patientRole.patient.ethnicGroupCode = CreateCodedWithExtensionElement(
                          subjectOfCare.Person.IndigenousStatus.GetAttributeValue<NameAttribute, string>(x => x.Code), CodingSystem.METEOR,
                          subjectOfCare.Person.IndigenousStatus.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null, null);
                }
                ...
                if (subjectOfCare.Person.DateOfDeath != null)
                {
                  ...
                  patient.patientRole.patient.deceasedTime = CreateTimeStampElementIso(subjectOfCare.Person.DateOfDeath);
                }
        ...
        private static Employment CreateEmployment(IEmploymentOrganisation organisation)
        {
          ...
          {
              employment.employerOrganization.asOrganizationPartOf.wholeOrganization.addr = CreateAddressArray(organisation.Addresses);
          }

          if (organisation.ElectronicCommunicationDetails != null && employment.employerOrganization != null)
          {
              employment.employerOrganization.asOrganizationPartOf.wholeOrganization.telecom = CreateTelecomunicationArray(organisation.ElectronicCommunicationDetails);
          }
        ...
        internal static POCD_MT000040Component1 CreateComponentOf(IParticipationHealthcareFacility healthcareFacility)
        {
          ...
          if (healthcareFacility.Participant != null)
          {
            ...
            if (healthcareFacility.Participant.ElectronicCommunicationDetails != null)
              castedParticipant.Participant.ElectronicCommunicationDetails = healthcareFacility.Participant.ElectronicCommunicationDetails;
        ...
        internal static POCD_MT000040Participant1 CreateParticipant(IParticipationRequester participation)
        {
            ...
            if (participation != null && participation.Participant != null)
            {
                ...
                returnParticipant = CreateParticipant(castedParticipation, ParticipationType.REF, RoleClassAssociative.ASSIGNED, null);
            }
        ...
        /// <returns>POCD_MT000040Participant1</returns>
        internal static POCD_MT000040Participant1 CreateParticipant(IParticipation participation, ParticipationType participationType, RoleClassAssociative roleClassAssociative, CE functionCode)
        {
          POCD_MT000040Participant1 returnParticipant = null;
          ...
          if (participation != null && participation.Participant != null)
          {
              ...
              associatedEntity =
                  new POCD_MT000040AssociatedEntity
                  {
                    ...
                    associatedPerson = participation.Participant.Person != null 
                            ...
                            {
                            // PersonName
                            name = participation.Participant.Person != null && participation.Participant.Person.PersonNames != null && participation.Participant.Person.PersonNames.Any()  ? CreatePersonNameArray(participation.Participant.Person.PersonNames) : null,
                            // EntityIdentifier
                            asEntityIdentifier = participation.Participant.Person != null && participation.Participant.Person.Identifiers != null && participation.Participant.Person.Identifiers.Any() ? CreateEntityIdentifier(participation.Participant.Person.Identifiers).ToArray() : null
                            }
                            : null,
                    // Addresses
                    addr = CreateAddressArray(participation.Participant.Addresses),
            ...
            if (participation.Participant.Person != null)
            {
                ...
                if (participation.Participant.Person.Organisation != null)
                {
                    ...
                    if (!String.IsNullOrWhiteSpace(participation.Participant.Person.Organisation.Name))
                        returnParticipant.associatedEntity.associatedPerson.asEmployment = CreateEmployment(participation.Participant.Person.Organisation);
                    else
                    {
                        returnParticipant.associatedEntity.associatedPerson.asEmployment = new Employment
                        {
                            nullFlavor = NullFlavor.NI,
                            nullFlavorSpecified = true
                        };
                    }
                }
            ...
            if (participation.Participant.Qualifications != null)
                returnParticipant.associatedEntity.associatedPerson.asQualifications = CreateQualifications(participation.Participant.Qualifications);
        ...
        internal static POCD_MT000040Participant1 CreateParticipant(IParticipationUsualGP participation)
        {
          ...
          if (participation != null && participation.Participant != null)
          {
            ...
            var functionCode = CreateCodedWithExtensionElement("PCP", null, "Primary Care Physician", null, null, null);
        ...
        private static POCD_MT000040Participant2 CreateParticipant2(IParticipationPrescriberInstructionRecipient participation)
        {
        ...
        private static POCD_MT000040Participant2 CreateParticipant2(IParticipationReportingPathologist participation)
        {
            ...
            if (participation != null && participation.Participant != null)
            {
                ...
                returnParticipant = CreateParticipant2(castedParticipation, ParticipationType.RESP, RoleClassRoot.ASSIGNED);
            }
          ...
          if (participation.Participant != null)
          {
            returnParticipant = new POCD_MT000040Participant2
            {
              ...
              participantRole = new POCD_MT000040ParticipantRole
              {
                ...
                playingEntity = participation.Participant.Person != null ? new POCD_MT000040PlayingEntity
                {
                 
                  classCode = EntityClassRoot.PSN,
                  asEmployment =  participation.Participant.Person.Organisation != null ? CreateEmployment(participation.Participant.Person.Organisation) : null,
                  asQualifiedEntity = participation.Participant.Qualifications != null ? CreateQualifications(participation.Participant.Qualifications) : null,
                  name = participation.Participant.Person.PersonNames != null && participation.Participant.Person.PersonNames.Any() ? CreatePersonNameArray(participation.Participant.Person.PersonNames) : null,
                  // EntityIdentifier
                  asEntityIdentifier = participation.Participant.Person.Identifiers != null && participation.Participant.Person.Identifiers.Any() ? CreateEntityIdentifier(participation.Participant.Person.Identifiers).ToArray() : null,
                } : null,
                // Addresses
                addr = CreateAddressArray(participation.Participant.Addresses),
          ...
          if (participation != null && participation.Participant != null)
          {
            ...
            if (participation.Participant.Person != null && participation.Participant.Person.Organisation != null)
            {
              var wholeEntity = new Entity
              {
                ...
                name = new [] { CreateName(participation.Participant.Person.Organisation.Name, participation.Participant.Person.Organisation.NameUsage) }
              };
            ...
            {
              asEntityIdentifier = participation.Participant.Person != null ? CreateEntityIdentifierArray(participation.Participant.Person.Identifiers) : null,
              name = participation.Participant.Person != null ? CreatePersonNameArray(participation.Participant.Person.PersonNames) : null,
              classCode = EntityClassRoot.PSN,
            };
        ...
        internal static POCD_MT000040Participant2 CreateParticipant2(Repository repository)
        {
            ...
            if (repository != null)
            {
                ...
                participant.participantRole.playingDevice = new POCD_MT000040Device
                {
                    softwareName = !repository.SoftwareName.IsNullOrEmptyWhitespace() ? new SC { Text = new[] { repository.SoftwareName } } : null
                };
            }
        ...
        internal static POCD_MT000040Participant2 CreateParticipant2(IParticipationServiceRequester participation)
        {
          ...
          if (participation != null && participation.Participant != null)
          {
            ...
            var roleClassAssociative = (RoleClassRoot)Enum.Parse(typeof(RoleClassRoot), participation.RoleClassCodeCode.GetAttributeValue<NameAttribute, string>(x => x.Code));
            returnParticipant = CreateParticipant2(castedParticipation, ParticipationType.REFB, roleClassAssociative);
          }
        ...
        internal static POCD_MT000040Performer2 CreatePerformer(IParticipationServiceProvider participation)
        {
          ...
          if (participation != null && participation.Participant != null)
          {
            ...
            if (castedParticipation.Participant != null)
            {
                if (participation.Participant.Person != null)
                {
                    ...
                    if (participation.Participant.Person.Entitlements != null)
                        castedParticipation.Participant.Entitlements = participation.Participant.Person.Entitlements;

                    if (participation.Participant.Person.Qualifications != null)
                        castedParticipation.Participant.Qualifications = participation.Participant.Person.Qualifications;
                }
            ...
            performer = CreatePerformer(castedParticipation, ParticipationPhysicalPerformer.PRF, castedParticipation.Participant.UniqueIdentifier.ToString());
          }
          return performer;
        }
                ...
                if (participation.Participant.Person.Gender != null)
                {
                  performer.assignedEntity.assignedPerson.administrativeGenderCode =
                      CreateCodedWithExtensionElement(
                          ...
                          CodingSystem.Gender, participation.Participant.Person.Gender.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null, null);
                }
        ...
        /// </summary>
        /// <returns>POCD_MT000040Performer2</returns>
        internal static POCD_MT000040Performer2 CreatePerformer(IParticipation participation, ParticipationPhysicalPerformer typeCode, string id = null)
        {
          POCD_MT000040Performer2 performer = null;
            ...
            if (participation.Participant != null)
            {
              performer = new POCD_MT000040Performer2
              {
                ...
                assignedEntity =
                    ...
                    {
                      code = CreateCodedWithExtensionElement(participation.Role),
                      id = id.IsNullOrEmptyWhitespace() ? CreateIdentifierArray(CreateGuid(), null, null) : CreateIdentifierArray(id, null, null),
                      // Create assigned person
                      assignedPerson = (participation.Participant.Person == null) ? null : new POCD_MT000040Person
                      {
                        asEntityIdentifier = participation.Participant.Person.Identifiers != null ? CreateEntityIdentifier(participation.Participant.Person.Identifiers).ToArray() : null,
                        name = CreatePersonNameArray(participation.Participant.Person.PersonNames),
                        asEmployment = participation.Participant.Person.Organisation == null ? null : CreateEmployment(participation.Participant.Person.Organisation),
                        asQualifications = participation.Participant.Qualifications == null ? null : CreateQualifications(participation.Participant.Qualifications),
                      },
                      // Create Address
                      addr = CreateAddressArray(participation.Participant.Addresses),
                      telecom = CreateTelecomunicationArray(participation.Participant.ElectronicCommunicationDetails),
                      // Create Organization
                      representedOrganization = participation.Participant.Organisation == null ? null : CreateOrganisation(participation.Participant.Organisation),
                    }
              };
        ...
        private static AD CreateAddress(IAddress address)
        {
            ...
            if (address != null)
            {
                ...
                if (address.AddressPurpose != AddressPurpose.NotStatedUnknownInadequatelyDescribed)
                {
                    returnValue.use = new[]
                                          {
                                              (PostalAddressUse)Enum.Parse(typeof (PostalAddressUse),address.AddressPurpose.GetAttributeValue<NameAttribute, string>(a => a.Code))
                                          };
                }
        ...
        internal static POCD_MT000040Entry CreateDocument(Document document, DocumentProvenanceEnum documentProvenanceEnum)
        {
          var entryRelationships = new List<POCD_MT000040EntryRelationship>();
          ...
          if (document != null)
          {
            ...
            entry.act = new POCD_MT000040Act
            {
              ...
              code = CreateCodedWithExtensionElement(documentProvenanceEnum.GetAttributeValue<NameAttribute, string>(x => x.Code),
                                                      (CodingSystem)Enum.Parse(typeof(CodingSystem), documentProvenanceEnum.GetAttributeValue<NameAttribute, string>(x => x.CodeSystem)),
            ...
            if (document.DateTimeHealthEventEnded != null)
            {
              entryRelationships.Add(CreateEntryRelationshipACT(x_ActRelationshipEntryRelationship.COMP,
                                                                ...
                                                                x_DocumentActMood.EVN,
                                                                false,
                                                                CreateConceptDescriptor("103.15510.160.1.3", CodingSystem.NCTIS, "DateTime Health Event Ended", null),
                                                                null,
                                                                null,
        ...
        private static IEnumerable<POCD_MT000040Entry> CreateProcedureEntries(List<IMedicalHistoryItem> medicalHistoryItems, ICodableText medicalHistoryItemDescriptor)
        {
            var entryList = new List<POCD_MT000040Entry>();
        ...
        private static POCD_MT000040EntryRelationship CreateEntryRelationshipObservation(
            x_ActRelationshipEntryRelationship actRelationshipEntryRelationship, Boolean? negationInd, Boolean? showNegationInd, CD code,
            List<ANY> values, string statusCode, NullFlavor? effectiveTimeNullflavor)
        {
            var entryRelationship = CreateEntryRelationshipObservation(actRelationshipEntryRelationship, ActClassObservation.OBS, x_ActMoodDocumentObservation.EVN, null, null, code, null, null, values, null);
        ...
        private static POCD_MT000040EntryRelationship CreateEntryRelationshipObservation(
            ...
            List<ANY> values)
        {
          return CreateEntryRelationshipObservation(actRelationshipEntryRelationship, ActClassObservation.OBS, x_ActMoodDocumentObservation.EVN, inversion, null, code, null, null, values, null);
        }
      ...
      private static POCD_MT000040EntryRelationship CreateEntryRelationshipObservation(
        ...
        ICollection<II> id, List<ANY> values, List<POCD_MT000040EntryRelationship> entryRelationshipList, II specimenIdentifier)
      {
        var entryRelationshipObservation = CreateEntryRelationshipObservation(actRelationshipEntryRelationship, classCode, moodCode, inversion, effectiveTime, code, text, id, values, entryRelationshipList);

        if (specimenIdentifier != null)
        entryRelationshipObservation.observation.specimen =
      ...
      private static POCD_MT000040EntryRelationship CreateEntryRelationshipObservation(
          ...
          var entryRelationship = new POCD_MT000040EntryRelationship
          {
            ...
            act =
                new POCD_MT000040Act
                {
                  ...
                  code = code,
                  text = text,
                  effectiveTime = effectiveDateTime.HasValue ? CreateIntervalTimestamp(null, null, null, null, effectiveDateTime.Value.ToString(DATE_TIME_FORMAT), null) : null
                }
          };
        ...
        private static POCD_MT000040EntryRelationship CreateEntryRelationshipACT(x_ActClassDocumentEntryAct classCode, x_DocumentActMood moodCode, CD code, ST text, DateTime? effectiveTime)
        {
            ...
            CS testStatus, ITestResultGroup testResultGroup, CDADocumentType? cdaDocumentType)
        {
            ...
            if (testResultGroup != null && testResultGroup.Results != null && testResultGroup.Results.Any())
            {
                foreach (var testResult in testResultGroup.Results)
                {
                    ...
                    if ((testResult.ResultValueReferenceRangeDetails != null && testResult.ResultValueReferenceRangeDetails.Any()) || testResult.ResultValue != null || testResult.NormalStatus.HasValue)
                    {
                        ...
                        if (testResult.ResultValueReferenceRangeDetails != null && testResult.ResultValueReferenceRangeDetails.Any())
                        {
                                                       ...
                                                       new POCD_MT000040ObservationRange
                                                           {
                                                               ...
                                                               code  = CreateConceptDescriptor(resultValueReferenceRangeDetail.ResultValueReferenceRangeMeaning),
                                                               value = CreateIntervalPhysicalQuantity(resultValueReferenceRangeDetail.Range)
                                                           },
                                                       });
                            }
                    ...
                    {
                        relationships.Add(CreateRelationshipForTestResultStatus(testResult.ResultStatus));
                    }
        ...
        #region Entry Relationship 
         ...
         private static IEnumerable<POCD_MT000040EntryRelationship> CreateRelationshipsForEachImage(ICollection<ExternalData> images)
        {
        ...
        private static IEnumerable<POCD_MT000040EntryRelationship> CreateRelationshipForMedication(IMedicationItem medication, string commentDisplayName)
        {
            ...
            var changeTypeRelationshipList = new List<POCD_MT000040EntryRelationship>
                                                 {
                                                     CreateEntryRelationshipObservation(
                                                         ...
                                                         : CreateEntryRelationshipACT(
                                                             ...
                                                             false,
                                                             CreateConceptDescriptor("103.10177", CodingSystem.NCTIS, "Change or Recommendation Reason", null),
        ...
        private static IEnumerable<POCD_MT000040EntryRelationship> CreateRelationshipForEachImagingResultGroup(ICollection<IImagingResultGroup> resultGroups)
        {
          List<POCD_MT000040EntryRelationship> relationshipList = null;
        ...
        private static IEnumerable<POCD_MT000040EntryRelationship> CreateRelationshipForEachTestResultGroup(IEnumerable<ITestResultGroup> testResultGroups, CDADocumentType? cdaDocumentType)
        {
          List<POCD_MT000040EntryRelationship> relationshipList = null;
        ...
        private static IEnumerable<POCD_MT000040EntryRelationship> CreateRelationshipForEachSpecimenDetail(ICollection<SpecimenDetail> specimenDetails, CDADocumentType? documentType)
        {
          var relationshipList = new List<POCD_MT000040EntryRelationship>();
                                                                        ...
                                                                        new POCD_MT000040Observation
                                                                            {
                                                                                ...
                                                                                moodCode =
                                                                                    x_ActMoodDocumentObservation.EVN,
                                                                                code = CreateConceptDescriptor("103.16171", CodingSystem.NCTIS, "Sampling Preconditions", null),
                                                                                value = new List<ANY>
                                                                                        {
        ...
        private static POCD_MT000040Act CreateActEvent(x_ActClassDocumentEntryAct classCode, x_DocumentActMood moodCode, CD code)
        {
                                                              ...
                                                              string id = null)
        {
            ...
            {
                entry.act.effectiveTime = CreateIntervalTimestamp(effectiveTimeLow, effectiveTimeHigh, null, null, null,null);
            }
                                                    ...
                                                    externalDocument = new POCD_MT000040ExternalDocument
                                                    {
                                                       ...
                                                       templateId = new []
                                                        {    
                                                             ...
                                                             CreateIdentifierElement
                                                             (
                                                                 documentLink.TemplateId.Value.GetAttributeValue<NameAttribute, string>(x => x.TemplateIdentifier),
                                                  ...
                                                  externalAct = new POCD_MT000040ExternalAct
                                                                  {
                                                                    ...
                                                                    classCode = ActClassRoot.ACT,
                                                                    code = CreateConceptDescriptor("10", CodingSystem.PCEHRAssignedIdentifierRepository, CodingSystem.PCEHRAssignedIdentifierRepository.GetAttributeValue<NameAttribute, string>(x => x.Title), null)
                                                                  }
                                                }
                                              },    
        ...
        private static POCD_MT000040Entry CreateEntryActRelatedDocument(RelatedDocument relatedDocument, ICodableText studyIdentifier)
        {
            ...
            if (relatedDocument.ExaminationResultRepresentation != null)
                referenceList.Add(new POCD_MT000040Reference
                {
                    ...
                    externalDocument = new POCD_MT000040ExternalDocument
                    {
                        ...
                        text = relatedDocument.ExaminationResultRepresentation != null ? CreateEncapsulatedData(relatedDocument.ExaminationResultRepresentation) : null
                    }
                });
            ...
            var entry = new POCD_MT000040Entry
            {
                act =
                    new POCD_MT000040Act
                    {
                        ...
                        moodCode = x_DocumentActMood.EVN,
                        id = CreateIdentifierArray(CreateGuid(), null),
                        code = CreateConceptDescriptor(CreateCodableText(AdvanceCareInformationSections.RelatedDocument)),
                        ...
                        effectiveTime = relatedDocument.DocumentDetails != null && relatedDocument.DocumentDetails.ReportDate != null  ? CreateIntervalTimestamp(relatedDocument.DocumentDetails.ReportDate.ToString(), null, null, null, null, null) : null
                   }
            };
        ...
        internal static CE CreateCodedWithExtensionElement(string code, CodingSystem? codingSystem, string displayName, string originalText, List<ICodableTranslation> codableTranslations, NullFlavour? nullFlavor)
        {
        ...
        internal static CE CreateCodedWithExtensionElement(ICodableText code)
        {
            ...
            if (code != null)
            {
                ce = CreateCodedWithExtensionElement(code.Code, code.CodeSystemCode, code.CodeSystemName, code.CodeSystemVersion, code.DisplayName, code.OriginalText, code.Translations, code.NullFlavour);
            }
        ...
        private static CE CreateCodedWithExtensionElement(Enum status, NullFlavour? nullflavor)
        {
            ...
            if (status != null)
            {
                ce = CreateCodedWithExtensionElement(status.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                                     ...
                                                     status.GetAttributeValue<NameAttribute, String>(x => x.Name), null, null, nullflavor);
            }
            return ce;
        }

        internal static CE CreateCodedWithExtensionElement(string code, string codeSystemCode, string codeSystemName, string codeSystemVersion, string displayName, string originalText, List<ICodableTranslation> codableTranslations, NullFlavour? nullFlavor)
        {
        ...
        private static CS CreateCodeSystem(string code, string codeSystem, string codeSystemName, string displayName, string originalText, NullFlavour? nullFlavor)
        {
          CS cs = null;

          if (!String.IsNullOrEmpty(code) || !String.IsNullOrEmpty(codeSystem) ||
              !String.IsNullOrEmpty(codeSystemName) || !String.IsNullOrEmpty(displayName) || !String.IsNullOrEmpty(originalText) || nullFlavor.HasValue)
          {
            cs = new CS();
        ...
        internal static CD CreateConceptDescriptor(string code, CodingSystem? codingSystem, string displayName, string originalText, string codeSystemVersion, NullFlavour? nullFlavor)
        {
        ...
        internal static CD CreateConceptDescriptor(string code, CodingSystem? codingSystem, string displayName, string originalText)
        {
          return CreateConceptDescriptor(code, codingSystem, displayName, originalText, null, null);
        }

        private static CD CreateConceptDescriptor(string code, string codeSystem, string codeSystemName, string displayName, string originalText, NullFlavour? nullFlavor)
        {
          ICodableText codableText = new CodableText();
          codableText.Code = code;
        ...
        internal static CD CreateConceptDescriptor(ICodableText codableText)
        {
          ...
          if (codableText != null)
          {
            ...
            {
                cd.nullFlavor = (NullFlavor)Enum.Parse(typeof(NullFlavor), codableText.NullFlavour.Value.GetAttributeValue<NameAttribute, string>(x => x.Code));
        ...
        private static List<CD> CreateConceptDescriptorsForAnatomicalSites(ICollection<AnatomicalSite> anatomicalSites)
        {
          ...
          {
            componentDescriptionList = (from anatomicalSite in anatomicalSites where anatomicalSite != null select CreateConceptDescriptorForAnatomicalSite(anatomicalSite)).ToList();
          }

          return componentDescriptionList;
        }

        private static List<CD> CreateConceptDescriptorForAnatomicalSites(IEnumerable<IAnatomicalSiteExtended> anatomicalSites, ICodableText name)
        {
            IList<AnatomicalSite> anatomicalsitesList = anatomicalSites.Select(anatomicalSite => anatomicalSite as AnatomicalSite).ToList();
            return CreateConceptDescriptorForAnatomicalSites(anatomicalsitesList, name);
        }

        private static List<CD> CreateConceptDescriptorForAnatomicalSites(IList<AnatomicalSite> anatomicalSites, ICodableText name)
        {
            List<CD> componentDescriptionList = null;

            if (anatomicalSites != null && anatomicalSites.Any())
            {
                componentDescriptionList = (from anatomicalSite in anatomicalSites where anatomicalSite != null select CreateConceptDescriptorForAnatomicalSite(anatomicalSite, name)).ToList();
            }
...
//                cd.codeSystem = CodingSystem.AMTV3.GetAttributeValue<NameAttribute, string>(x => x.Code);
        ...
        private static POCD_MT000040EntryRelationship CreateAnatomicalRegionRelationship(AnatomicalRegion? anatomicalRegion)
        {
            POCD_MT000040EntryRelationship entryRelationship  =null;
            ...
            if (anatomicalRegion.HasValue)
            {
                entryRelationship = new POCD_MT000040EntryRelationship
                {
                    ...
                    observation = new POCD_MT000040Observation
                    {
                        ...
                        code = CreateConceptDescriptor(CreateCodableText(DiagnosticImagingReportSections.AnatomicalRegion)),
        ...
        /// <summary>
        /// Create a CodedValue for the given parameters with out the codeSystemVersion
        /// </summary>
        /// <param name="code">A string that represents the code</param>
        /// <param name="codingSystem">The CodingSystem for the code</param>
        /// <param name="displayName">The associated display name for the coded text</param>
          ...
          if (value != null)
          {
            ...
            else if (value.TestResultValue != null)
            {
              ...
              if (value.TestResultValue != null)
              {
                ...
                physicalQuantity.value = !value.TestResultValue.Value.IsNullOrEmptyWhitespace() ? value.TestResultValue.Value : null;
              }
            }
        ...
        private static IVL_PQ CreateIntervalPhysicalQuantity(QuantityRange quantityRange)
        {
          ...
          if (quantityRange != null)
          {
            ...
            pq.Items[0] = new IVXB_PQ { unit = quantityRange.Units, value = quantityRange.Low.HasValue ? quantityRange.Low.Value.ToString(CultureInfo.InvariantCulture) : null };

            pq.ItemsElementName[1] = ItemsChoiceType.high;
            pq.Items[1] = new IVXB_PQ { unit = quantityRange.Units, value = quantityRange.High.HasValue ? quantityRange.High.Value.ToString(CultureInfo.InvariantCulture) : null };
          }
        ...
        private static ED CreateEncapsulatedData(ExternalData externalData)
        {
          ...
          if (externalData != null)
          {
            ...
            ed = new ED
            {
              ...
              integrityCheckAlgorithm = externalData.DigestCheckAlgorithm.HasValue && externalData.DigestCheckAlgorithm.Value == DigestCheckAlgorithm.SHA256 ? IntegrityCheckAlgorithm.SHA256 : IntegrityCheckAlgorithm.SHA1
            };
          }
        ...
        private static TEL[] CreateTelecomunicationArray(List<ElectronicCommunicationDetail> electronicCommunicationDetails)
        {
          TEL[] telArray = null;
          ...
          if (electronicCommunicationDetails != null && electronicCommunicationDetails.Any())
          {
            ...
            electronicCommunicationDetails.ForEach(
                electronicCommunicationDetail => telecomunicationsList.Add(CreateTelecomunication(electronicCommunicationDetail)));
        ...
        private static PN CreatePersonName(IPersonName personName)
        {
          ...
          if (personName != null)
          {
            ...
            if (personName.NameUsages != null)
            {
              ...
              {
                uses.Add((EntityNameUse)Enum.Parse(typeof(EntityNameUse), usage.GetAttributeValue<NameAttribute, string>(x => x.Code)));
              }
        ...
        private static POCD_MT000040Observation CreateSpecimenDetail(SpecimenDetail specimenDetail, ICodableText code)
        {
          ...
          if (specimenDetail != null)
          {
            ...
            {
              observation.methodCode = new List<CE> { CreateCodedWithExtensionElement(specimenDetail.CollectionProcedure) }.ToArray();
            }
            ...
            if (specimenDetail.AnatomicalSite != null && specimenDetail.AnatomicalSite.Any())
            {
              observation.targetSiteCode = CreateConceptDescriptorsForAnatomicalSites(specimenDetail.AnatomicalSite).ToArray();
            }
        ...
        private static List<EntityIdentifier> CreateEntityIdentifier(IEnumerable<Identifier> identifiers)
        {
          ...
          if (identifiers != null)
          {
            entityidentifiers = (from identifier in identifiers where identifier != null select CreateEntityIdentifier(identifier)).ToList();
          }
        ...
        internal static  EntityIdentifier CreateEntityIdentifier(Identifier identifier)
        {
          ...
          if (identifier.NullFlavour.HasValue)
          {
              ...
              {
                  id = CreateIdentifierElement(null, (NullFlavor)Enum.Parse(typeof(NullFlavor), identifier.NullFlavour.Value.GetAttributeValue<NameAttribute, string>(x => x.Code)))
              };
          }
        ...
        internal static POCD_MT000040Section CreateSectionCodeTitle<T>(T defaultValue) where T : struct, IConvertible
        {
          ...
          var section = new POCD_MT000040Section
          {
            ...
            text = enumeration.GetAttributeValue<NameAttribute, string>(x => x.Narrative) != null ? new StrucDocText { paragraph = new[] { new StrucDocParagraph { Text = new[] { enumeration.GetAttributeValue<NameAttribute, string>(x => x.Narrative) } } } } : new StrucDocText(),
            id = CreateIdentifierElement(CreateGuid(), null)
          };
        ...
        private static POCD_MT000040Entry CreateEntrySubstanceAdministrationEvent(x_ActRelationshipEntry? actRelationshipEntry, x_DocumentSubstanceMood substanceMood, bool showStatusCode, ST text, string low, string high, ISO8601DateTime effectiveTime, CE CEcode, int? repeatNumber, List<POCD_MT000040EntryRelationship> relationships, string id)
        {
          return CreateEntrySubstanceAdministrationEvent(actRelationshipEntry, substanceMood, showStatusCode, text, low, high, effectiveTime, CEcode, repeatNumber, relationships, null, "active", null, id, null, null, null, null);
        }

        private static POCD_MT000040Entry CreateEntrySubstanceAdministrationEvent(x_ActRelationshipEntry? actRelationshipEntry, x_DocumentSubstanceMood substanceMood, bool showStatusCode, ST text, string low, string high, ISO8601DateTime effectiveTime, CE CEcode, int? repeatNumber, string genericName, ICodableText formCode, ICodableText routeCode, Identifier manufacturerOrganizationId, List<POCD_MT000040EntryRelationship> relationships, string id)
        {
          return CreateEntrySubstanceAdministrationEvent(actRelationshipEntry, substanceMood, showStatusCode, text, low, high, effectiveTime, CEcode, repeatNumber, relationships, null, "active", null, id, genericName, formCode, routeCode, manufacturerOrganizationId);
        }

        private static POCD_MT000040Entry CreateEntrySubstanceAdministrationEvent(x_ActRelationshipEntry? actRelationshipEntry, x_DocumentSubstanceMood substanceMood, bool showStatusCode, string statusCode, ST text, string low, string high, ISO8601DateTime effectiveTime, CE CEcode, int? repeatNumber, string genericName, ICodableText formCode, ICodableText routeCode, Identifier manufacturerOrganizationId, List<POCD_MT000040EntryRelationship> relationships, string id)
        {
          return CreateEntrySubstanceAdministrationEvent(actRelationshipEntry, substanceMood, showStatusCode, text, low, high, effectiveTime, CEcode, repeatNumber, relationships, null, statusCode, null, id, genericName, formCode, routeCode, manufacturerOrganizationId);
        }

        private static POCD_MT000040Entry CreateEntrySubstanceAdministrationEvent(x_ActRelationshipEntry? actRelationshipEntry, x_DocumentSubstanceMood substanceMood, bool showStatusCode, ST text, string low, string high, ISO8601DateTime effectiveTime, CE CEcode, int? repeatNumber, List<POCD_MT000040EntryRelationship> relationships, string statusCode, string id)
        {
          return CreateEntrySubstanceAdministrationEvent(actRelationshipEntry, substanceMood, showStatusCode, text, low, high, effectiveTime, CEcode, repeatNumber, relationships, null, statusCode, null, id, null, null, null, null);
        }

        private static POCD_MT000040Entry CreateEntrySubstanceAdministrationEvent(x_ActRelationshipEntry actRelationshipEntry, x_DocumentSubstanceMood substanceMood, bool showStatusCode, ST text, CdaInterval interval, DateTime? effectiveTime, CE CEcode, int? repeatNumber, List<POCD_MT000040EntryRelationship> relationships, string id)
        {
            return CreateEntrySubstanceAdministrationEvent(actRelationshipEntry, substanceMood, showStatusCode, text, interval, effectiveTime, CEcode, repeatNumber, relationships, null, "active", null, id);
        }
        ...
        /// </summary>
        /// <returns></returns>
        private static POCD_MT000040Entry CreateEntrySubstanceAdministrationEventATS(x_ActRelationshipEntry actRelationshipEntry, x_DocumentSubstanceMood substanceMood, bool showStatusCode, ST text, IEnumerable<ITime> complextTimeList, CE CEcode, int? repeatNumber, List<POCD_MT000040EntryRelationship> relationships, Boolean? negationIndicator, String statusCode, List<Subject1> subjects, Identifier id, List<PBSExtemporaneousIngredient> ingredient, QuantityUnit quantityUnit, bool? prn, FrequencyQuantity frequencyQuantity, Identifier medicationInstructionIdentifier, AdministrationDetails administrationDetails)
        {
          var entry = new POCD_MT000040Entry
          {
            typeCode = actRelationshipEntry,
          ...
          if (administrationDetails != null)
          {
            if (administrationDetails.Route != null)
              entry.substanceAdministration.routeCode = CreateCodedWithExtensionElement(administrationDetails.Route);

            if (administrationDetails.AnatomicalSite != null)
              entry.substanceAdministration.approachSiteCode = new[] { CreateConceptDescriptor(administrationDetails.AnatomicalSite) };

            if (administrationDetails.MedicationDeliveryMethod != null)
              entry.substanceAdministration.methodCode = CreateConceptDescriptor(administrationDetails.MedicationDeliveryMethod);
          }
                                                                    ...
                                                                    externalAct = new POCD_MT000040ExternalAct
                                                                                      {
                                                                                          ...
                                                                                          code = CreateConceptDescriptor
                                                                                            (
                                                                                                AdminCodes.MedicationInstructionIdentifier.GetAttributeValue<NameAttribute, String>(x => x.Code),
                                                                                                ...
                                                                                                AdminCodes.MedicationInstructionIdentifier.GetAttributeValue<NameAttribute, String>(x => x.Name),
                                                                                                null,
                                                                                                null
                                                                                             )
                                                                                      }
            ...
            entry.substanceAdministration.consumable = new POCD_MT000040Consumable
            {
              manufacturedProduct = new POCD_MT000040ManufacturedProduct
              {
                manufacturedMaterial = new POCD_MT000040Material
                {
                  ...
                  formCode = quantityUnit != null && quantityUnit.Unit != null ? CreateConceptDescriptor(quantityUnit.Unit) : null
                }
              }
            };
          ...
          if (repeatNumber.HasValue)
          {
            ...
            entry.substanceAdministration.repeatNumber.Items = new INT[] { new IVXB_INT { value = repeatNumber.Value.ToString(CultureInfo.InvariantCulture) } };
          }
          ...
          if (quantityUnit != null)
          {
            if (quantityUnit.Quantity != null)
              entry.substanceAdministration.doseQuantity = new IVL_PQ
              {
                ...
                value = !quantityUnit.Quantity.Value.IsNullOrEmptyWhitespace() ? quantityUnit.Quantity.Value : null,
              };
          }
        ...
        private static POCD_MT000040Entry CreateEntrySubstanceAdministrationEventATS(x_ActRelationshipEntry actRelationshipEntry, x_DocumentSubstanceMood substanceMood, bool showStatusCode, string statusCode, ST text, List<ITime> complextTimeList, CE CEcode, int? repeatNumber, List<POCD_MT000040EntryRelationship> relationships, List<PBSExtemporaneousIngredient> ingredient, QuantityUnit quantityUnit, Identifier id, bool? prn, FrequencyQuantity frequencyQuantity, Identifier medicationInstructionIdentifier, AdministrationDetails administrationDetails)
        {
          return CreateEntrySubstanceAdministrationEventATS(actRelationshipEntry, substanceMood, showStatusCode, text, complextTimeList, CEcode, repeatNumber, relationships, null, statusCode, null, id, ingredient, quantityUnit, prn, frequencyQuantity, medicationInstructionIdentifier, administrationDetails);
        }
        ...
        private static Ingredient[] CreatePBSExtemporaneousIngredient(ICollection<PBSExtemporaneousIngredient> pbsExtemporaneousIngredient)
        {
              ...
              observationRange =
                new POCD_MT000040ObservationRange
                {
                  ...
                  code = referenceRangeDetails.ReferenceRangeMeaning != null ?
                   ...
                   : null,
                  value = referenceRangeDetails.ReferenceRange != null ? CreateIntervalPhysicalQuantity(referenceRangeDetails.ReferenceRange) : null
                },
            };
          }
        ...
        private static Coverage CreatePolicyOrAccount(ActClass actClass, ActMood actMood, Identifier id, CD conceptDescriptor)
        {
          Coverage coverage = null;
        ...
        private static EIVL_TS CreateComplexTime(EventRelatedIntervalOfTime time)
        {
          ...
          if (time != null)
          {
            ...
            if (time.Operator.HasValue)
              complexTime.@operator = (SetOperator)Enum.Parse(typeof(SetOperator), time.Operator.GetAttributeValue<NameAttribute, string>(x => x.Code));

            if (time.Event.HasValue)
              complexTime.@event = new EIVLevent { code = time.Event.Value.GetAttributeValue<NameAttribute, string>(x => x.Code) };
        ...
        private static PIVL_TS CreateComplexTime(PeriodicIntervalOfTime time)
        {
          ...
          if (time != null)
          {
            ...
            {
              complexTime.alignment = (CalendarCycle)Enum.Parse(typeof(CalendarCycle), time.Alignment.GetAttributeValue<NameAttribute, string>(x => x.Code));
        ...
        private static IEnumerable<POCD_MT000040Entry> CreateAdministeredImmunisations(ICollection<IImmunisation> immunisations)
        {
          var entryList = new List<POCD_MT000040Entry>();
          ...
          if (dateTime != null)
          {
            entry = new POCD_MT000040Entry
            {
              observation = new POCD_MT000040Observation
              {
                classCode = ActClassObservation.OBS,
                moodCode = x_ActMoodDocumentObservation.EVN,
                code = CreateConceptDescriptor("103.15507", CodingSystem.NCTIS, "Earliest Date for Filtering", null),
                id = CreateIdentifierArray(CreateGuid(), null),
          ...
          if (dateTime != null)
          {
            entry = new POCD_MT000040Entry
            {
              observation = new POCD_MT000040Observation
              {
                classCode = ActClassObservation.OBS,
                moodCode = x_ActMoodDocumentObservation.EVN,
                code = CreateConceptDescriptor("103.15510", CodingSystem.NCTIS, "Latest Date for Filtering", null),
                id = CreateIdentifierArray(CreateGuid(), null),
                value = new ANY[] { CreateTimeStampElementIso(dateTime) }
              }
            };
        ...
        private static POCD_MT000040Entry CreateAdministrationObservationAge(DateAccuracyIndicator dateAccuracyIndicator, String accuracyIndicatorType, String accuracyIndicatorTypeCode)
        {
          ...
          if (dateAccuracyIndicator != null)
          {
            ...
            anyList.Clear();
            anyList.Add(CreateCodeSystem(dateAccuracyIndicatorEnum.ToString(), null, null, dateAccuracyIndicatorEnum.GetAttributeValue<NameAttribute, String>(x => x.Name), null, null));
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV,
                                           CreateConceptDescriptor(accuracyIndicatorTypeCode, CodingSystem.NCTIS, accuracyIndicatorType + " Accuracy Indicator", null),
        ...
        private static POCD_MT000040Entry CreateAdministrationObservationMothersOriginalFamilyName(IPersonName personName)
        {
          ...
          if (personName != null)
          {
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV, CreateConceptDescriptor("103.10245", CodingSystem.NCTIS, "Mother's Original Family Name", null), null, anyList, null, null);
          }
        ...
        private static POCD_MT000040Entry CreateAdministrationObservationSourceOfDeathNotification(SourceOfDeathNotification? sourceOfDeathNotification)
        {
          ...
          if (sourceOfDeathNotification.HasValue)
          {
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV, CreateConceptDescriptor("103.10243", CodingSystem.NCTIS, "Source of Death Notification", null), null, anyList, null, null);
          }
        ...
        private static POCD_MT000040Entry CreateAdministrationObservationAge(Int32? age, AgeUnitOfMeasure? ageUnitOfMeasure)
        {
          ...
          if (age.HasValue)
          {
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV, CreateConceptDescriptor("103.20109", CodingSystem.NCTIS, "Age", null), null, anyList, null, null);
          }
        ...
        private static POCD_MT000040Entry CreateAdministrationObservationBirthPlurality(Int32? birthPlurality)
        {
          ...
          if (birthPlurality.HasValue)
          {
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV, CreateConceptDescriptor("103.16249", CodingSystem.NCTIS, "Birth Plurality", null), null, anyList, null, null);
          }
        ...
        private static POCD_MT000040Entry CreateAdministrationObservationAgeAccuracyIndicator(Boolean? ageAccuracyIndicator)
        {
          ...
          if (ageAccuracyIndicator.HasValue)
          {
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV, CreateConceptDescriptor("103.16279", CodingSystem.NCTIS, "Age Accuracy Indicator", null), null, anyList, null, null);
          }
        ...
        private static POCD_MT000040Entry CreateAdministrationObservationDateOfBirthCalculatedFromAge(Boolean? dateOfBirthCalculatedFromAge)
        {
          ...
          if (dateOfBirthCalculatedFromAge.HasValue)
          {
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV, CreateConceptDescriptor("103.16233", CodingSystem.NCTIS, "Date of Birth is Calculated From Age", null), null, anyList, null, null);
          }
          ...
          if (medicareDVAFundedService != null)
          {
            ...
            entry = new POCD_MT000040Entry
            {
              encounter = new POCD_MT000040Encounter
              {
                ...
                id = CreateIdentifierArray(CreateGuid(), null),
                code = CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.MedicareMBSDVAItem)),
                ...
                reference = CreatesReferanceLink(CreateCodableText(MedicareOverviewSections.MedicareDVAFundedServicesDocumentLink), medicareDVAFundedService.MedicareDVAFundedServicesDocumentLink)
              }
            };
          }
                                            ...
                                            externalAct = new POCD_MT000040ExternalAct
                                                            {
                                                              ...
                                                              text = new ED
                                                              {
                                                                  mediaType = mediaType.HasValue ? mediaType.Value.GetAttributeValue<NameAttribute, string>(x => x.Name) : null,
                                                                  reference = new TEL
                                                                  {
                                                                      value = imageLocation
                                                                  }
          ...
          if (pharmaceuticalBenefitItem != null)
          {
            ...
            entry = new POCD_MT000040Entry
            {
              supply = new POCD_MT000040Supply
              {
                ...
                moodCode = x_DocumentSubstanceMood.EVN,
                code = CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.PharmaceuticalBenefitsItem)),
                ...
                reference = CreatesReferanceLink(CreateCodableText(MedicareOverviewSections.PharmaceuticalBenefitItemsDocumentLink),pharmaceuticalBenefitItem.PharmaceuticalBenefitItemDocumentLink),
        ...
        /// <returns>POCD_MT000040Entry</returns>
        internal static POCD_MT000040Entry CreateEntryBodyHeightLength(PhysicalMeasurementBodyHeightLength bodyHeightLength)
        {
          POCD_MT000040Entry entry = null;
          var anyList = new List<ANY>();
          var entryRelationshipList = new List<POCD_MT000040EntryRelationship>();
          ...
          if (bodyHeightLength != null)
          {
            ...
            {
              entryRelationshipList.Add(CreateEntryRelationshipObservation(x_ActRelationshipEntryRelationship.COMP,
                                                                           null, null,
            ...
            if (bodyHeightLength.ConfoundingFactor != null && bodyHeightLength.ConfoundingFactor.Any())
            {
              foreach (var confoundingFactor in bodyHeightLength.ConfoundingFactor)
              {
                if (confoundingFactor != null)
                  entryRelationshipList.Add(CreateEntryRelationshipACT(x_ActRelationshipEntryRelationship.SUBJ,
                                                                       x_ActClassDocumentEntryAct.INFRM,
                                                                       x_DocumentActMood.EVN,
                                                                       false,
                                                                       CreateConceptDescriptor(CreateCodableText(PhysicalMeasurementDocumentSections.ConfoundingFactorName)),
          ...
          if (bodyWeight != null)
          {
            ...
            if (bodyWeight.WeightEstimationFormula != null)
            {
              entryRelationshipList.Add(CreateEntryRelationshipACT(x_ActRelationshipEntryRelationship.COMP,
                                                                   ...
                                                                   x_DocumentActMood.EVN,
                                                                   null,
                                                                   CreateConceptDescriptor(CreateCodableText(PhysicalMeasurementDocumentSections.WeightEstimationFormula)),
            ...
            if (bodyWeight.Pregnant.HasValue)
            {
              ...
              entryRelationshipList.Add(CreateEntryRelationshipObservation(x_ActRelationshipEntryRelationship.COMP,
                                                                           ...
                                                                           CreateConceptDescriptor(CreateCodableText(PhysicalMeasurementDocumentSections.ASSERTION.GetAttributeValue<NameAttribute, string>(x => x.Code),
                                                                                                                    CodingSystem.ActCode.GetAttributeValue<NameAttribute, string>(x => x.Code), null, null, null, null)),
                                                                           new List<ANY> { CreateConceptDescriptor(CreateCodableText(PhysicalMeasurementDocumentSections.Pregnant)) },
                                                                          StatusCode.Completed.GetAttributeValue<NameAttribute, string>(a => a.Name), NullFlavor.NA));
        ...
        internal static POCD_MT000040Entry CreateEntryHeadCircumference(HeadCircumference headCircumference)
        {
          ...
          if (headCircumference != null)
          {
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.DRIV,
                                           ...
                                           null,
                                           new[] { CreateConceptDescriptor(CreateCodableText(PhysicalMeasurementDocumentSections.HeadStructure)) },
        ...
        internal static POCD_MT000040Entry CreateAchievement(Achievement achievements)
        {
          ...
          var code = CreateCodedWithExtensionElement(CreateCodableText(ConsumerEnteredAchievementsSections.Achievement));
          ...
          entry.observation = new POCD_MT000040Observation
          {
            ...
            moodCode = x_ActMoodDocumentObservation.EVN,
            code = code,
            templateId = CreateIdentifierArray(ConsumerEnteredAchievementsSections.Achievement.GetAttributeValue<NameAttribute, string>(x => x.Identifier), null),
            value = !achievements.AchievementDescription.IsNullOrEmptyWhitespace() ? new ANY[] { CreateStructuredText(achievements.AchievementDescription, null) } : null,
            effectiveTime = achievements.AchievementDate != null ? CreateIntervalTimestamp(achievements.AchievementDate, null) : null,
            author = achievements.InformationProvider != null ? new[] { CreateInformationProvider(achievements.InformationProvider) } : null,
            statusCode = CreateCodeSystem(StatusCode.Completed.GetAttributeValue<NameAttribute, string>(x => x.Name), null, null, null, null, null)
          };
        ...
        internal static POCD_MT000040Entry CreateAustralianOrganDonorRegisterEntry(AustralianOrganDonorRegisterEntry australianOrganDonorRegisterEntry)
        {
          ...
          if (australianOrganDonorRegisterEntry != null)
          {
            ...
            if (australianOrganDonorRegisterEntry.OrganAndTissueDonationDetails != null && australianOrganDonorRegisterEntry.OrganAndTissueDonationDetails.BoneTissueIndicator.HasValue)
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.BoneTissueIndicator)),
                                                                                new List<ANY> { CreateBoolean(australianOrganDonorRegisterEntry.OrganAndTissueDonationDetails.BoneTissueIndicator.Value, 
                                                                              true) }
                                                                                ));
            }
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.EyeTissueIndicator)),
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.HeartIndicator)),
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.HeartValveIndicator)),
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.KidneyIndicator)),
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.LiverIndicator)),
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.LungsIndicator)),
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.PancreasIndicator)),
            ...
            {
              components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.SkinTissueIndicator)),
             ...
             (australianOrganDonorRegisterEntry.OrganAndTissueDonationDetails.SkinTissueIndicator.HasValue))
            {
              entryRelationshipList.Add(CreateEntryRelationshipOrganiserObservation(
                                                x_ActRelationshipEntryRelationship.SUBJ,
                                                CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.OrganAndTissueDonationDetails)),
            ...
            entry = CreateEntryObservation(x_ActRelationshipEntry.COMP,
                                          CreateConceptDescriptor(CreateCodableText(MedicareOverviewSections.AustralianOrganDonorRegisterEntry)),
                                          null,
          ...
          if (item != null)
          {
            var observation = CreateEntryObservation
              (
                ...
                item.DateTimePrescriptionExpires != null ? CreateIntervalTimestamp(null, null, null, null, item.DateTimePrescriptionExpires.ToString(), null) : null,
                null,
                null,
                null
              );
            ...
            var entryRelationship = new POCD_MT000040EntryRelationship
            {
              ...
              supply = new POCD_MT000040Supply
              {
                ...
                // Begin Brand Substitute allowed
                subjectOf2 = item.DispensingInformation != null && item.DispensingInformation.BrandSubstitutionPermitted.HasValue ?
                             CreateBrandSubstituteAllowed
                              (
                                  ActClass.SUBST,
                                  ActMood.PERM,
                ...
                entryRelationship = item.DispensingInformation != null && !item.DispensingInformation.QuantityDescription.IsNullOrEmptyWhitespace() ? new[]
                                  {
                                    ...
                                    (
                                        ...
                                        x_DocumentActMood.INT,
                                        false,
                                        CreateConceptDescriptor(CreateCodableText(EtpRecordSections.QuantityDescription.GetAttributeValue<NameAttribute, String>(x => x.Code), 
                                                                                  CodingSystem.SNOMED, 
                                                                                  EtpRecordSections.QuantityDescription.GetAttributeValue<NameAttribute, String>(x => x.Name), null)),
        ...
        internal static POCD_MT000040Entry CreateDispenseItemEntryRelationship(PCEHRDispenseItem item)
        {
                ...
                entryRelationship = new[] 
                                                                   {
                                                                     !item.QuantityDescription.IsNullOrEmptyWhitespace() ? CreateEntryRelationshipACT
                                                                                                                             (
                                                                                                                               ...
                                                                                                                               x_DocumentActMood.EVN,
                                                                                                                               false,
                                                                                                                               CreateConceptDescriptor(CreateCodableText(EtpRecordSections.QuantityDescription.GetAttributeValue<NameAttribute, String>(x => x.Code), CodingSystem.SNOMED, EtpRecordSections.QuantityDescription.GetAttributeValue<NameAttribute, String>(x => x.Name), null)),
          ...
          // Prescription Item Id
          // root = Data Component Register - Set Prescription Item Identifier 
          entry.substanceAdministration.id = item.PrescriptionItemIdentifier != null ? CreateIdentifierArray(item.PrescriptionItemIdentifier) : null;
            ...
            using (var xmlWriter = XmlWriter.Create(stringBuilder))
            {
              if (xmlWriter != null)
              {
                try
                {
                  ...
                  XmlComment productVersionComment = returnXmlDocument.CreateComment(string.Format(@"Generated using 'NEHTA Vendor Library - CDA' version {0}", assembly.GetName().Version));
                  ...
                  {
                    XmlComment templatePackageComment = returnXmlDocument.CreateComment(string.Format(@"The following template packages are supported for {0}: {1}", templatePackage.DocumentName, templatePackage.TemplatePackages));
        ...
        public static TemplatePackageAttribute GetTemplatePackage(Type type)
        {
            ...
            if (type != null)
            {
                ...
                var templatePackages = type.GetAttributeValue<TemplatePackageAttribute, string>(x => x.TemplatePackages);
     ...
     /// <param name="logoByte">A byte array for the logo</param>
      ...
      internal static XmlDocument CreateXml(POCD_MT000040ClinicalDocument clinicalDocument,
        ...
        internal static POCD_MT000040EntryRelationship CreateVaccineCancellationReason(VaccineCancellationReason vaccineAdministrationEntry)
        {
          ...
          {
            cd = CreateConceptDescriptor(CreateCodableText(vaccineAdministrationEntry.VaccineType.Value.GetAttributeValue<NameAttribute, string>(x => x.Code),
          ...
          {
            cd = CreateConceptDescriptor(null, null as string, null, null, null, vaccineAdministrationEntry.VaccineTypeNullFlavour);
          }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreatePrescriptionAndDispenseViewExclusionStatement(ExclusionStatement exclusionStatement, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          if (exclusionStatement != null && !exclusionStatement.GeneralStatement.IsNullOrEmptyWhitespace())
          {
            ...
            entryList.Add(CreateExclusionStatement(exclusionStatement.GeneralStatement, "103.16135.179.1.1", "General Statement"));
            component.section.entry = entryList.ToArray();
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreatePathologyResultViewExclusionStatement(ExclusionStatement exclusionStatement, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
        ...
        /// <param name="narrativeGenerator"> The Narrative Generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(PrescribingAndDispensingReports prescribingAndDispensingReports, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          var components = new List<POCD_MT000040Component5>() ;
          ...
          if (prescribingAndDispensingReports != null)
          {
            ...
            component.section = new POCD_MT000040Section
            {
              code = CreateCodedWithExtensionElement(CreateCodableText(PrescribingAndDispensingViewRecordSections.PrescribingAndDispensingReports)),
            ...
            if (prescribingAndDispensingReports.MedicationEntriesWithSummary != null)
              foreach(var medicationEntryWithSummary in prescribingAndDispensingReports.MedicationEntriesWithSummary)
              {
                components.Add(CreateMedicationEntriesWithSummary(medicationEntryWithSummary, narrativeGenerator));
              }

            component.section.component = components.ToArray();

            component.section.text = prescribingAndDispensingReports.CustomNarrative ?? narrativeGenerator.CreateNarrative(prescribingAndDispensingReports);
        ...
        /// </summary>
        /// <returns>POCD_MT000040Component5</returns>
        internal static POCD_MT000040Component5 CreateMedicationEntriesWithSummary(MedicationEntriesWithSummary medicationEntriesWithSummary, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component5 component = null;
          var components = new List<POCD_MT000040Component5>();
          ...
          foreach (var medicationEntries in medicationEntriesWithSummary.MedicationEntries)
          {
            ...
            {
              components.Add(CreateComponent(medicationEntries.PrescriptionItem as PCEHRPrescriptionItem, narrativeGenerator));
            }

            if (medicationEntries.DispenseItem != null)
            {
              components.Add(CreateComponent(medicationEntries.DispenseItem as PCEHRDispenseItem, narrativeGenerator));
            }
          }

          if (medicationEntriesWithSummary.SummaryOfMedicationEntries != null)
          {
            entryList.Add(CreateSummaryOfMedicationEntries(medicationEntriesWithSummary.SummaryOfMedicationEntries, narrativeGenerator));
          }
          ...
          component = new POCD_MT000040Component5
          {
            section = new POCD_MT000040Section
                        {
                          code = CreateCodedWithExtensionElement(CreateCodableText(PrescribingAndDispensingViewRecordSections.MedicationEntriesWithSummary)),
        ...
        /// </summary>
        /// <returns>POCD_MT000040Component5</returns>
        internal static POCD_MT000040Entry CreateSummaryOfMedicationEntries(SummaryOfMedicationEntries summaryOfMedicationEntries, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Entry entry = null;
          var components = new List<POCD_MT000040Component4>();
                                ...
                                observation = new POCD_MT000040Observation
                                                {
                                                  classCode = ActClassObservation.OBS,
                                                  moodCode = x_ActMoodDocumentObservation.EVN,
                                                  code = CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.TherapeuticGoodIdentification)),
          ...
          if (summaryOfMedicationEntries.DateTimePrescriptionWritten != null)
          {
            var component = new POCD_MT000040Component4
            {
              observation = new POCD_MT000040Observation
              {
                classCode = ActClassObservation.OBS,
                moodCode = x_ActMoodDocumentObservation.EVN,
                code = CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.DateTimePrescriptionWritten)),
                value = new ANY[] { CreateTimeStampElementIso(summaryOfMedicationEntries.DateTimePrescriptionWritten) }
              }
            };
          ...
          if (summaryOfMedicationEntries.DateTimeOfEarliestDispenseEvent != null)
          {
            var component = new POCD_MT000040Component4
            {
              observation = new POCD_MT000040Observation
              {
                classCode = ActClassObservation.OBS,
                moodCode = x_ActMoodDocumentObservation.EVN,
                code = CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.DateTimeOfEarliestDispenseEvent)),
                value = new ANY[] { CreateTimeStampElementIso(summaryOfMedicationEntries.DateTimeOfEarliestDispenseEvent) }
              }
            };
          ...
          if (summaryOfMedicationEntries.DateTimeOfLatestDispenseEvent != null)
          {
            var component = new POCD_MT000040Component4
            {
              observation = new POCD_MT000040Observation
              {
                classCode = ActClassObservation.OBS,
                moodCode = x_ActMoodDocumentObservation.EVN,
                code = CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.DateTimeOfLatestDispenseEvent)),
                value = new ANY[] { CreateTimeStampElementIso(summaryOfMedicationEntries.DateTimeOfLatestDispenseEvent) }
              }
            };
          ...
          if (summaryOfMedicationEntries.TotalNumberOfKnownSupplies != null)
          {
            var component = new POCD_MT000040Component4
            {
              observation = new POCD_MT000040Observation
              {
                classCode = ActClassObservation.OBS,
                moodCode = x_ActMoodDocumentObservation.EVN,
                code = CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.TotalNumberOfKnownSupplies)),
                value = new ANY[] { CreateIntegerElement(summaryOfMedicationEntries.TotalNumberOfKnownSupplies, null, null) }
              }
            };
          ...
          if (summaryOfMedicationEntries.MaximumNumberOfPermittedSupplies.HasValue)
          {
            var component = new POCD_MT000040Component4
            {
              observation = new POCD_MT000040Observation
              {
                classCode = ActClassObservation.OBS,
                moodCode = x_ActMoodDocumentObservation.EVN,
                code = CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.MaximumNumberOfPermittedSupplies)),
                value = new ANY[] { CreateIntegerElement(summaryOfMedicationEntries.MaximumNumberOfPermittedSupplies, null, null) }
              }
            };
                      ...
                      organizer = new POCD_MT000040Organizer
                                    {
                                      classCode = x_ActClassDocumentEntryOrganizer.CLUSTER,
                                      moodCode = ActMood.EVN,
                                      code = CreateConceptDescriptor(CreateCodableText(PrescribingAndDispensingViewRecordSections.SummaryOfMedicationEntries)), 
                                      component = components.ToArray(),
                                      statusCode = new CS { code = StatusCode.Completed.GetAttributeValue<NameAttribute, string>(x => x.Name) }
                                    }
                    };
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(MeasurementInformation item, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          if (item != null)
          {
            ...
            component = new POCD_MT000040Component3
            {
              section = new POCD_MT000040Section
              {
                  ...
                  code = CreateCodedWithExtensionElement(CreateCodableText(CeHRRecordSections.PhysicalMeasurements)),
                  title = CreateStructuredText(CeHRRecordSections.PhysicalMeasurements.GetAttributeValue<NameAttribute, string>(x => x.Title), null)
              }
            };
            ...
            if (item.HeadCircumference != null)
            {
               components.Add(CreateComponentObservation(
                    ...
                    null, CreateIdentifierArray(CreateGuid()), CreateIdentifierArray("1.2.36.1.2001.1001.101.102.16808")));
            }

            if (item.BodyHeight != null)
            {
               components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.CTBodyHeight)),
                              new List<ANY> {CreatePhysicalQuantity(item.BodyHeight) },
                              null, CreateIdentifierArray(CreateGuid()),  CreateIdentifierArray("1.2.36.1.2001.1001.101.102.16123")));
            }

            if (item.BodyWeight != null)
            {
               components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.CTBodyWeight)),
                              new List<ANY> {CreatePhysicalQuantity(item.BodyWeight) },
                              null, CreateIdentifierArray(CreateGuid()),  CreateIdentifierArray("1.2.36.1.2001.1001.101.102.16124")));
            }

            if (item.BodyMassIndex != null)
            {
                components.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.CTBodyMassIndex)),
                               new List<ANY> { CreatePhysicalQuantity(item.BodyMassIndex) },
                               null, CreateIdentifierArray(CreateGuid()), CreateIdentifierArray("1.2.36.1.2001.1001.101.102.161255")));
            }
              ...
              var entry = new POCD_MT000040Entry
                            {
                              ...
                              organizer = new POCD_MT000040Organizer
                                            {
                                              code = CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.ProviderEnteredMeasurementInformation)),
                                              moodCode = ActMood.EVN,
                                              classCode = x_ActClassDocumentEntryOrganizer.CLUSTER,
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(List<MeasurementInformation> items, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
            ...
            foreach (var item in items)
            {
              ...
              if (item.BodyMassIndex != null)
              {
                ...
                var entry = new POCD_MT000040Entry
                {
                  ...
                  {
                    id = CreateIdentifierArray(CreateGuid()),
                    code = CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.ConsumerEnteredMeasurementInformation)),
                    moodCode = ActMood.EVN,
                    classCode = x_ActClassDocumentEntryOrganizer.CLUSTER,
                    statusCode = new CS { code = StatusCode.Completed.GetAttributeValue<NameAttribute, string>(a => a.Name) },
                    effectiveTime = CreateIntervalTimestamp(item.ObservationDate, null),
                    component = components.ToArray()
                  }
                };
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(Questionnaire questionnaire, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          component = new POCD_MT000040Component3
          {
            section = new POCD_MT000040Section
            {
              ...
              title = new ST { Text = new [] { questionnaire.SectionCode.Value.GetAttributeValue<NameAttribute, string>(x => x.Name) } } 
            }
          };
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(HealthCheckAssesment healthCheckAssesment, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          component = new POCD_MT000040Component3
          {
            section = new POCD_MT000040Section
            {
              code = CreateCodedWithExtensionElement(CreateCodableText(healthCheckAssesment.SectionCode.Value)),
              title = CreateStructuredText(healthCheckAssesment.SectionCode.Value.GetAttributeValue<NameAttribute, string>(x => x.Name), null)
            }
          };
            ...
            if (assessmentItems != null && assessmentItems.Any())
            {
                ...
                foreach (var assessmentItem in assessmentItems)
                {
                    ...
                    components.Add(new POCD_MT000040Component4
                                               {
                                                   observation = CreateObservation(ActClassObservation.OBS, x_ActMoodDocumentObservation.EVN, CreateConceptDescriptor(assessmentItem.QuestionData), null, null, enttryRelationshipList)
                                               }
                                   );
                        }
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(BirthDetails birthDetails, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          if (birthDetails != null)
          {
            component = new POCD_MT000040Component3
            {
              section = new POCD_MT000040Section
              {
                ...
                title = CreateStructuredText(CeHRRecordSections.BirthDetails.GetAttributeValue<NameAttribute, string>(x => x.Title), null),
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static List<POCD_MT000040Component3> CreateComponent(List<QuestionnaireDocumentData> questionnaireDocuments, INarrativeGenerator narrativeGenerator)
        {
          ...
          if (questionnaireDocuments != null && questionnaireDocuments.Any())
          {
            foreach (var questionnaireDocument in questionnaireDocuments)
            {
                ...
                var component = new POCD_MT000040Component3
                {
                  ...
                  section = questionnaireDocument.QuestionnairesData.HasValue ? new POCD_MT000040Section
                              {
                                id = CreateIdentifierElement(CreateGuid(), null),
                                title = CreateStructuredText(questionnaireDocument.QuestionnairesData.Value.GetAttributeValue<NameAttribute, string>(x => x.Name), null),
                                code = CreateCodedWithExtensionElement(CreateCodableText(questionnaireDocument.QuestionnairesData.Value))
                              } : null
                ...
                {
                  organizerComponents.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.IncompleteFlag)),
                ...
                {
                  organizerComponents.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.PCEHR_AUTID)),
                ...
                {
                  organizerComponents.Add(CreateComponentObservation(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.PCEHR_DOCTIME)),
                                                                     new List<ANY> { CreateIntervalTimestamp(questionnaireDocument.DocumentDate, null) }));
                }

                // Exclusion Statement
                if (questionnaireDocument.DocumentLink == null && questionnaireDocument.Assessment == null &&  questionnaireDocument.AuthorName == null && questionnaireDocument.DocumentDate == null )
                {
                  ...
                  section.entry = new[] { CreateExclusionStatementStructuredText(CeHRRecordSections.GlobalStatement, statementForEmptyEntries) };
        ...
        /// <param name="narrativeGenerator">The narrative generator</param>
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component3 CreateComponent(List<MeasurementEntry> measurementEntrys, CeHRRecordSections ceHhrRecordSections, INarrativeGenerator narrativeGenerator)
        {
          POCD_MT000040Component3 component = null;
          ...
          if (measurementEntrys != null)
          {
            component = new POCD_MT000040Component3
            {
              ...
              section = new POCD_MT000040Section
              {
                ...
                title = CreateStructuredText(ceHhrRecordSections.GetAttributeValue<NameAttribute, string>(x => x.Name), null)
              }
            };
            ...
            foreach (var measurementEntry in measurementEntrys)
            {
                ...
                if (measurementEntry.BodyHeightMeasure != null)
                  organizerComponents.Add(CreateComponent(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.BodyHeightMeasure)), CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.Percentile)), measurementEntry.BodyHeightMeasure));

                if (measurementEntry.BodyWeightMeasure != null)
                  organizerComponents.Add(CreateComponent(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.BodyWeight)), CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.Percentile)), measurementEntry.BodyWeightMeasure));

                if (measurementEntry.HeadCircumferenceMeasure != null)
                  organizerComponents.Add(CreateComponent(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.HeadCircumference)), CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.Percentile)), measurementEntry.HeadCircumferenceMeasure));

                if (measurementEntry.BodyMassIndex != null)
                  organizerComponents.Add(CreateComponent(CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.BodyMassIndex)), CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.Percentile)), measurementEntry.HeadCircumferenceMeasure));

                if (measurementEntry.DocumentLink != null)
                {
                  var linkEntry = CreateEntryLink(x_DocumentActMood.EVN, CreateConceptDescriptor(CreateCodableText(CeHRRecordSections.RecordLink)), measurementEntry.DocumentLink);
        ...
        /// <returns>POCD_MT000040Component3</returns>
        internal static POCD_MT000040Component4 CreateComponent(CD code, CD percentileCode, MeasurementComponent measurementComponent)
        {
          var component = new POCD_MT000040Component4
          { 
            typeCode = ActRelationshipHasComponent.COMP,
            ...
            observation =
              new POCD_MT000040Observation
              {
                ...
                id = CreateIdentifierArray(CreateGuid()),
                code = code,
                value = measurementComponent.ComponentValue != null ? new ANY[] { CreatePhysicalQuantity(measurementComponent.ComponentValue) } : null,
                entryRelationship =  measurementComponent.PercentileValue != null && measurementComponent.ComponentValue != null ? new [] { CreateEntryRelationshipObservation(x_ActRelationshipEntryRelationship.MFST, 
                                                                       null,
                                                                       percentileCode,
