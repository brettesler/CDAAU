...
namespace Nehta.VendorLibrary.CDA.CDAModel
{
    ...
    /// </summary>
    public interface ICDAContextEventSummary
    {
        #region Properties
        ...
        /// <summary>
        /// Validate the CDA Context for this EventSummary, Mandatory Legal Authenticator
        /// </summary>
        /// <param name="path">The path to this object as a string</param>
        /// <param name="messages">the validation messages, these may be added to within this method</param>
        void ValidateWithMandatoryLegalAuthenticator(string path, List<ValidationMessage> messages);
